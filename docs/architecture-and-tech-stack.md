...
- 현대백화점 외 계열사는 제품·권한·손익 계산 대상에서 제외합니다.
- 1차 실증은 더현대 서울 직매입 재고와 의류·신발 등 1~2개 상품군에 집중합니다.
- 다른 현대백화점 점포 비교와 점포 간 재고 이동은 P2 후순위 기능입니다.
- P0/P1에서는 현재 점포의 할인·타임세일·아울렛·기부·폐기 대안을 먼저 검증합니다.
- 점포 간 이동을 도입할 때는 이동비·수신 용량·판매속도·권한을 별도로 검증합니다.
