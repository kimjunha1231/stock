globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/content-CEwbI_Yp.js","assets/reveal-YOJmgnTk.js","assets/image-CFgqE4Ha.js","assets/layout-segment-context-BNWi1hre.js","assets/link-xbuXr7of.js","assets/router-g05YNnyR.js","assets/page-BZ8SXXqd.js","assets/page-DlQnVyib.js","assets/glossary-browser-CZgzJk6G.js","assets/site-shell-CoyC7BVT.js","assets/term-hint-WqbboY67.js"];
...
function getDraftSecret() {
	return "c3867d3f-8e2e-4d4f-97ec-a6a796543e19";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "d51f78da-746c-4030-8f46-a64c4716773c";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "d51f78da-746c-4030-8f46-a64c4716773c") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "d51f78da-746c-4030-8f46-a64c4716773c",
		rootBoundaryId
	});
}
/**
...
var sequenceSteps = [
	[
		"01",
		"기준 잡기",
		"외부 자료와 프로젝트 요구사항을 구분하고, 무엇을 사실로 사용할지 정합니다."
	],
	[
		"02",
		"상품·계열사 정리",
		"3개 계열사의 상품군과 비용·위험 차이를 공통 구조에 연결합니다."
	],
	[
		"03",
		"ERD·DB 설계",
		"상품·SKU·재고·판매·비용·예측·전략이 어떤 키로 이어지는지 정합니다."
	],
	[
		"04",
		"데이터 준비",
		"원천 데이터를 모으고 품절·반품·오류를 정리해 계산 가능한 상태로 만듭니다."
	],
	[
		"05",
		"AI 기능 실행",
		"트렌드 → 수요예측 → 위험판단 → 전략계산 순서로 처리합니다."
	],
	[
		"06",
		"학습·검증",
		"기준모델과 비교하고 미래 데이터를 섞지 않아도 성능이 좋아지는지 확인합니다."
	],
	[
		"07",
		"화면·승인",
		"결과를 쉬운 말로 설명하고 담당자가 확인·승인합니다."
	],
	[
		"08",
		"실제 결과 회수",
		"판매·매출·잔여재고를 저장해 다음 예측과 정책 개선에 사용합니다."
	]
];
var affiliateRows = [
	[
		"현대웰니스",
		"비타민·마그네슘·오메가3·콜라겐·건강식품",
		"product → sku → lot",
		"성분·기능·대상·소비기한·보관조건·표시·회수상태",
		"보관비·폐기비·반품비·할인 제한",
		"소비기한·표시·회수 상태"
	],
	[
...
var commonDbRows = [
	[
		"기준정보",
		"affiliate · legal_entity · channel · category · brand",
		"계열사·법인·채널·카테고리를 공통 ID로 관리"
	],
	[
		"상품",
		"product · product_option · sku · external_product_mapping",
		"공통 상품, 옵션, 실제 재고 단위, 원천 코드 연결"
	],
	[
		"재고",
		"inventory_snapshot · inventory_lot · inventory_movement",
		"현재고·예약분·가용수량·로트·입출고 흐름 저장"
	],
	[
		"판매",
		"sales_event · promotion_event · return_event",
		"판매량·가격·할인·품절·반품을 날짜별로 저장"
	],
	[
		"AI 입력",
		"trend_signal · feature_snapshot · forecast_run",
		"트렌드 원천·계산자료·예측값·예측 범위 저장"
	],
	[
		"전략",
		"policy_profile · risk_assessment · strategy_candidate · simulation_run",
		"정책·위험 이유·전략 후보·시뮬레이션 저장"
	],
	[
		"운영",
		"model_version · data_quality_issue · approval_event · audit_log",
		"재현·오류·승인·변경 이력 저장"
	]
];
var erdRelations = [
	[
		"계열사 → 상품",
		"affiliate 1 : N product",
		"한 계열사가 여러 공통 상품을 가질 수 있습니다."
	],
	[
		"상품 → SKU",
		"product 1 : N sku",
		"색상·용량·옵션·판매 단위가 다르면 SKU를 나눕니다."
	],
	[
		"SKU → 재고·판매",
		"sku 1 : N inventory_snapshot / sales_event",
		"재고와 판매는 기준시각·발생시각을 가진 이력입니다."
	],
	[
		"SKU → AI 입력",
		"sku 1 : N trend_signal / forecast_run",
		"트렌드 원천과 예측 실행 결과를 연결합니다."
	],
	[
		"SKU → 비용",
		"sku 1 : 0..1 sku_cost_profile",
		"상품별 비용이 다를 때만 개별 비용 프로필을 둡니다."
	],
	[
		"전략 → 실행 이력",
		"strategy_candidate → simulation_run → approval_event",
		"추천·시뮬레이션·승인을 서로 다른 기록으로 남깁니다."
	]
];
var costRows = [
	[
	...
	[
		...
		"계산 당시 복사본",
		"snapshot_id·sku_id·배송비·설치비·보관비·예상 파손비·예상 반품비·폐기비·정책 버전",
		"과거 결과 재현"
	]
];
var dataSteps = [
	...
	[
		"02",
		"공통 변환",
		"계열사 원천 코드·단위·날짜를 공통 상품·SKU 형식으로 바꿉니다."
	],
	[
		"03",
		"품질 검사",
		"누락·중복·음수 수량·가격 오류·기준시각 지연을 찾아 격리합니다."
	],
	[
		"04",
		"판매 보정",
		"품절일·취소·반품을 분리해 판매 부진으로 잘못 학습하지 않습니다."
	],
	[
		"05",
		"트렌드 생성",
		"검색·SNS·조회·판매 변화와 출처·수집시각을 저장합니다."
	],
	[
		"06",
		"스냅샷 확정",
		"계산에 사용한 데이터 상태와 기준시각을 고정합니다."
	]
];
var aiRows = [
	[
		...
		"트렌드 신호",
		"통계 계산",
		"검색·SNS·조회·판매 변화를 합쳐 상승·유지·하락 신호 생성",
		"검색량만 급증하고 판매·재고가 부족하면 자동 입고로 확정하지 않음"
	],
	[
		"AI-02",
		"수요예측",
		"학습 모델",
		"기본수요에 트렌드·가격·프로모션·계절·요일 효과 추가",
		"예측값·범위·소진일·신뢰 상태를 함께 표시"
	],
	[
		"AI-03",
		"위험재고",
		"규칙 엔진",
		"소비기한·법규·소유권·데이터 품질과 위험점수 계산",
		"판매 불가 조건은 점수보다 먼저 차단"
	],
	[
		"AI-04",
		"전략 후보",
		"수식 엔진",
		"할인·쿠폰·채널·번들·기간별 손익을 계산하고 순위화",
	...
	[
		...
		"결과 설명",
		"생성형 AI",
		"계산된 후보와 근거를 담당자가 이해하는 문장으로 변환",
		"가격·수량·점수를 새로 만들거나 변경하지 않음"
	]
];
var formulaCards = [
	{
...
var affiliateFormulaRows = [
	[
		"현대웰니스",
		"건강기능식품·영양제",
		"product → sku → lot",
		"Q_available = 판매 가능한 로트 수량(최소 잔여기한 충족)",
		"기한 압박·판매속도·폐기비·표시/회수 상태",
		"배송·포장·검수·반품·폐기비",
		"성분·기능 관심 상승 + 실제 판매 상승이면 입고·프로모션 후보. 기한·표시·회수 문제가 있으면 차단"
	],
	[
		"현대리바트",
		"가구·리빙·옵션·모듈",
		"product → option → sku",
		"Q_available = min(재고−예약, 배송 가능량, 설치 가능량)",
		"보관일·납기·설치 슬롯·파손/AS·반품 비용",
		"배송·설치·보관·파손·재배송·반품비·무료배송 기준",
		"인테리어 관심과 판매가 함께 오르면 노출·할인 후보. 설치 슬롯·정책이 없으면 차단"
	],
	[
		"현대그린푸드",
		"농산물·수산물·축산물·가공·케어푸드",
		"product → sku → lot",
		"Q_available = 판매 가능한 로트 수량과 냉장·냉동 처리량 중 작은 값",
		"소비기한·주문마감·온도·검사·이력추적·폐기량",
		"콜드체인·피킹·포장·보냉재·폐기·반품비",
		"메뉴·검색·판매가 함께 오르면 추가 입고 후보. 소비기한·검사·콜드체인 문제가 있으면 차단"
	]
];
var strategyBuildRows = [
	[
		"최대 마진",
		"M_inc가 가장 큰 후보를 선택",
		"할인율을 낮게 시작하고 배송·설치·반품 비용을 모두 차감",
		"최소 마진율·최소 판매량 미만은 제외"
	],
	[
		"빠른 소진",
		"처리기한 안의 예상 잔여재고가 가장 작은 후보를 선택",
		"할인·채널 노출·기간을 조합하고 보관·폐기 회피비용을 반영",
		"기한 안에 처리되지 않으면 제외"
	],
	[
		"최대 매출",
		"예상 판매수량 × 할인 후 가격이 가장 큰 후보를 선택",
		"트렌드·프로모션·채널 효과를 크게 반영",
		"마진 하한과 법적 제한은 유지"
	],
	[
		"위험 최소화",
		"위험점수·예상 손실·폐기량이 가장 많이 줄어드는 후보를 선택",
		"기한·파손·콜드체인·설치 실패 비용에 가중치",
		"실제로 줄어드는 비용만 계산"
	]
];
var forecastSteps = [
	[
		"01",
		"기준모델",
		"카테고리 평균·이동평균·지수평활을 기준으로 둡니다."
	],
	[
		"02",
		"학습 자료",
		"최소 28일 판매·품절·가격·프로모션·반품·재고 이력을 모읍니다."
	],
	[
		"03",
		"정답 연결",
		"기준일 이후 7일·14일 실제 판매량을 정답으로 연결합니다."
	],
	[
		"04",
		"시간순 검증",
		"미래 데이터를 섞지 않고 계열사·카테고리별 오차를 확인합니다."
	],
	[
		"05",
		"계층 보정",
		"SKU 합계가 카테고리·계열사·전체 합계와 맞는지 확인합니다."
	],
	[
		"06",
		"운영·재학습",
		"예측 오차가 쌓인 뒤 모델 버전과 함께 재학습합니다."
	]
];
var inventoryRows = [
	[
	...
	[
		"예상수요·트렌드",
		"예측 일판매량과 상승·유지·하락 신호",
		"수요 변화 조기 확인"
	],
	[
		"처리기한·비용",
		"소비기한·배송·설치·보관·반품·폐기 조건",
		"하드 차단·손익 계산"
	],
	[
		"위험·추천 행동",
...
var methodologyRows = [
	...
	[
		"재고·가격 연구",
		"가격·재고·폐기·반품 비용 구성 확인",
		"전략 목적함수·후보 순위"
	],
	[
		"프로젝트 요구사항",
		"3개 계열사·원가 비노출·승인 범위 확정",
		"화면·ERD·권한·운영 흐름"
	]
];
var sourceIds = [
...
function AiBlueprintPage() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: [
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Reveal, { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h1", { children: [
						"처음 읽는 팀원도",
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "순서대로 이해하는 AI 재고 전략" })
					] }) }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Reveal, { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "자료를 왜 참고했는지, 어떤 데이터를 DB에 넣는지, AI가 어떤 순서로 계산하는지, 화면에서 무엇을 보여주는지 한 흐름으로 정리했습니다." }) }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "actions",
						style: { marginTop: 26 },
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(link_default, {
		...
		/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("section", {
			className: "section blueprint-sequence-section",
			children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				className: "container",
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "section-heading",
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h2", { children: [
							"이 페이지는",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "이 순서로 보면 됩니다." })
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "각 단계의 결과가 다음 단계의 입력이 됩니다. 먼저 DB를 만들고, 그 다음 AI 계산을 붙입니다." })
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					className: "blueprint-sequence-grid",
					children: sequenceSteps.map(([num, title, body]) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h2", { children: [
								"AI를 여러 개 만들기보다",
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "공통 모델과 정책을 조합합니다." })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "초기에는 계열사별 AI 모델을 따로 학습하지 않습니다. 데이터가 적은 상품도 공통 패턴을 활용하고, 계열사 차이는 정책 프로필과 비용 프로필에서 처리합니다." })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "검색·SNS·조회·판매 변화로 트렌드 상승·유지·하락을 계산합니다." })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "핵심 분리 원칙" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "수요예측 → 위험·하드 차단 → 전략 수식 계산 → AI 설명 → 담당자 승인" }), " 순서입니다. AI 설명 도우미는 가격·수량을 직접 정하지 않습니다."] })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
							...
							note: "공식 계열사 상품·사업 자료에서 확인한 운영 차이를 반영했습니다."
						})]
					})
				]
			})
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
								className: "eyebrow",
								children: "02 · ERD·DB 설계"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h2", { children: [
								"공통 테이블과",
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "계열사 확장·비용 프로필" })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "DB는 “어떤 자료가 필요한가”와 “어떤 키로 연결되는가”를 먼저 정합니다. 화면에 보이지 않는 원가도 계산용 데이터로 저장합니다." })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "blueprint-source-layout",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SimpleTable, {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "MVP 비용 프로필" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "가구의 가로·세로·높이·부피는 저장하지 않습니다. 배송비·무료배송 기준금액·설치비·보관비·예상 파손비·예상 반품비·폐기비를 SKU별 또는 계열사 기본 정책으로 저장합니다." })]
							})]
						}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SourceRail, {
							ids: ["project-types", "project-policy"],
							note: "프로젝트 요구사항과 공통 ID 원칙을 DB 구조로 바꾼 부분입니다."
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "blueprint-guide-section-heading",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "ERD 관계" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h3", { children: [
							"어떤 테이블이",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
						className: "blueprint-erd-grid",
						children: erdRelations.map(([title, relation, body]) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: title }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("code", { children: relation }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: body })
						] }, title))
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "blueprint-guide-section-heading",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "비용 프로필" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h3", { children: [
							"계산에 직접 쓰는 값을",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "어디에 저장하는지" })
						] })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SimpleTable, {
						caption: "비용 프로필 저장 구조",
						headers: [
							"저장 영역",
							"뜻",
							"주요 컬럼 후보",
		...
		/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("section", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h2", { children: [
								"원천 데이터를",
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "계산 가능한 상태로 만듭니다." })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "AI보다 먼저 상품 코드·날짜·수량·판매 상태를 정리합니다. 데이터가 부족하면 추천하지 않는 것도 결과입니다." })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
						className: "blueprint-operation-flow",
						children: dataSteps.map(([num, title, body]) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: num }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: title }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: body })
						] }, num))
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "blueprint-guide-rule",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "고정해야 하는 기록" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [
							"모든 계산에는 기준시각·데이터 상태·",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("code", { children: "model_version" }),
							"·",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("code", { children: "formula_version" }),
							"·",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("code", { children: "policy_version" }),
							"·",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("code", { children: "snapshot_id" }),
							"를 남깁니다."
						] })]
					})
				]
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
							className: "eyebrow",
							children: "04 · AI 기능 실행"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h2", { children: [
							"각 기능은",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "입력과 결과가 다릅니다." })
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "AI라고 부르더라도 실제로 학습하는 기능, 규칙으로 처리하는 기능, 설명만 하는 기능을 구분합니다." })
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SimpleTable, {
					caption: "AI 기능별 입력·결과·운영 원칙",
					headers: [
						"ID",
						"기능",
						"종류",
					...
					rows: aiRows,
					className: "blueprint-ai-function-table-wrap"
				})]
			})
		}),
		/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("section", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h2", { children: [
								"신호를 모아",
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "비용과 이익으로 비교합니다." })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "검색량 하나로 결론을 내리지 않습니다. 실행 가능 여부를 먼저 확인하고, 트렌드를 반영한 수요·비용·위험을 계산한 뒤 기준선과 비교합니다." })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("summary", { children: [
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "필요한 입력값" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: card.inputs })] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "계열사별 적용" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: card.affiliate })] })]
									})
								]
							})]
						}, card.id))
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "blueprint-guide-rule blueprint-guide-rule-green",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "계산의 핵심 원칙" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [
							"수식 자체는 공통으로 유지하고, ",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "계열사·카테고리·SKU의 입력값과 가중치·비용 프로필" }),
							"만 바꿉니다. 그래서 같은 상품이 같은 기준시각과 같은 데이터로 계산되면 누구나 같은 결과를 재현할 수 있습니다."
						] })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SourceRail, {
						ids: [
						...
						note: "프로젝트 정책과 수요·재고·가격 연구를 실행 순서와 수식으로 합친 기준안입니다."
					})
				]
			})
		}),
		/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("section", {
			className: "section-tight band blueprint-affiliate-formula-section",
			children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				className: "container",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
								className: "eyebrow",
								children: "05-B · 계열사·상품별 적용"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h2", { children: [
								"공통 수식에",
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "상품 특성만 다르게 넣습니다." })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "계열사마다 AI 모델을 따로 만드는 것이 아니라, 상품의 재고 단위·처리기한·비용·하드 차단을 프로필로 바꿔 같은 계산 흐름에 넣습니다." })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SimpleTable, {
						caption: "계열사와 상품 유형별 수식 입력 차이",
						headers: [
							"계열사",
							"대표 상품 유형",
							"재고 단위",
						...
						rows: affiliateFormulaRows,
						className: "blueprint-affiliate-formula-table"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "blueprint-guide-rule",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "가구 크기 필드에 대한 결정" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [
							"이번 MVP는 가로·세로·높이·부피 자체를 재고 전략의 핵심 필드로 저장하지 않습니다. 대신 배송비·무료배송 기준금액·설치비·보관비·예상 파손비·예상 반품비처럼 ",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "비용을 직접 발생시키는 수치" }),
							"를 SKU 비용 프로필에 저장합니다. 실제 물류 시스템에서 크기가 필요해지는 경우에도 전략 DB에는 비용으로 환산된 값만 우선 사용합니다."
						] })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "blueprint-guide-section-heading",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "상품별 입력 규칙" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h3", { children: [
							"어떤 상품이든",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "먼저 이 네 가지를 채웁니다." })
						] })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "blueprint-product-rule-grid",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "01" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "무엇을 한 단위로 셀까?" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "웰니스·그린푸드는 로트, 리바트는 옵션이 반영된 SKU를 기준으로 재고·판매를 연결합니다." })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "02" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "언제까지 팔아야 할까?" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "식품은 소비기한·주문마감, 가구는 납기·설치일, 웰니스는 최소 잔여기한을 사용합니다." })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "03" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "팔 때 어떤 비용이 생길까?" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "배송·설치·콜드체인·포장·반품·파손·폐기처럼 전략을 실행할 때 실제로 변하는 값만 넣습니다." })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "04" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "팔면 안 되는 경우는?" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "법적 제한·표시·검사·회수·소유권·capacity가 확인되지 않으면 이익 계산 전에 차단합니다." })
							] })
						]
					})
				]
		...
		/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("section", {
			className: "section blueprint-strategy-build-section",
			children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				className: "container",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
								className: "eyebrow",
								children: "05-C · 목표별 전략 만들기"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h2", { children: [
								"담당자가 목표를 고르면",
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "후보 순위 기준이 바뀝니다." })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "하드 차단은 항상 먼저 적용하고, 그 다음 담당자가 선택한 목표에 맞춰 같은 후보들의 순위를 다시 계산합니다." })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SimpleTable, {
						caption: "목표별 전략 수식 적용 방법",
						headers: [
							"목표",
							"선택 기준",
							"수식에서 더 크게 보는 값",
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "blueprint-operation-flow blueprint-strategy-flow",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "01" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "기준선 저장" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "아무것도 하지 않을 때의 예상 판매·비용·잔여재고를 고정합니다." })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "02" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "조건 입력" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "할인율·쿠폰·기간·수량·채널·번들 여부를 담당자가 바꿉니다." })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "03" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "수식 재계산" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "같은 데이터 snapshot으로 수요·비용·위험·이익을 다시 계산합니다." })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "04" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "후보 비교" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "보수·기본·낙관 시나리오와 목표별 순위를 비교합니다." })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "05" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "설명·승인" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "AI는 근거를 쉬운 문장으로 설명하고 담당자가 승인합니다." })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "06" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "실제 결과 저장" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "판매량·매출·잔여재고를 저장해 다음 예측을 검증합니다." })
							] })
						]
					})
				]
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h2", { children: [
								"기준모델보다 좋아지는지",
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "시간순으로 검증합니다." })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "복잡한 모델을 먼저 붙이지 않습니다. 데이터가 쌓이면 기준모델 → 트렌드 피처 → 계층 보정 순으로 확장합니다." })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SimpleTable, {
						caption: "수요예측 학습·검증 순서",
						headers: ["단계", "팀원이 할 일"],
						rows: forecastSteps
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "blueprint-guide-rule blueprint-guide-rule-green",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "자동화 경계" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "자동 입고·자동 가격변경·자동 판매 등록은 하지 않습니다. 검증된 추천과 시뮬레이션 결과를 담당자가 확인하고 승인합니다." })]
					})
				]
			})
		}),
		/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("section", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h2", { children: [
								"DB와 계산 결과를",
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "담당자 화면에 이렇게 보여줍니다." })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "원가는 기본 화면에 보이지 않고, 위험·비용·추천 행동·기준시각을 중심으로 보여줍니다." })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SimpleTable, {
						caption: "통합 재고 화면 표시 컬럼",
						headers: [
							"표시 항목",
							"공통 의미",
							"사용 목적"
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "blueprint-guide-rule",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "승인 흐름" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "전략 후보 생성 → 담당자 조건 수정 → 수식 재계산 → 추천 이유·하방 결과 확인 → 승인 요청 → 승인 이력 저장 → 실제 결과 회수" })]
					})
				]
			})
		}),
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
								className: "eyebrow",
								children: "08 · 근거와 적용 방법"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h2", { children: [
								"자료를 그대로 복사하지 않고",
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "기준·필드·계산으로 바꿉니다." })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "공식 자료는 관리 대상을, 법·정책 자료는 차단 조건을, 연구는 계산·검증 방법을 정하고, 프로젝트 요구사항과 내부 데이터가 최종값을 확정합니다." })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SimpleTable, {
						caption: "참고 자료를 설계로 바꾸는 방법",
						headers: [
							"자료 묶음",
							"검토한 기준",
							"사이트에 반영한 결과"
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "확정 전 주의사항" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "현재 사이트의 테이블·필드·수식은 개발 기준안입니다. 실제 운영 전에는 각 계열사의 ERP·POS·WMS·재무 데이터로 필드명·단위·금액·가중치·임계값을 확정해야 합니다." })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "blueprint-guide-section-heading",
