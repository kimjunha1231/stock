globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/content-CgIAmXlb.js","assets/reveal-YOJmgnTk.js","assets/image-CFgqE4Ha.js","assets/layout-segment-context-B5ggIScW.js","assets/link-DofsKICi.js","assets/router-CgItyvvw.js","assets/page-Dyb9ecMd.js","assets/page-CSfYcvWL.js","assets/glossary-browser-DhoYE56H.js","assets/site-shell-BsNPmXCs.js","assets/term-hint-sal1Qio5.js"];
...
function getDraftSecret() {
	return "26c11d36-c71a-4c6c-bc35-04a6e4bc013c";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "530e7664-09f1-4602-83aa-04ae44085a37";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "530e7664-09f1-4602-83aa-04ae44085a37") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "530e7664-09f1-4602-83aa-04ae44085a37",
		rootBoundaryId
	});
}
/**
...
var affiliateFormulaRows = [
	...
	[
		...
		"가구·리빙·옵션·모듈",
		"product → option → sku",
		"Q_available = 보류 수량을 제외한 현재 재고",
		"보관일·납기·파손/AS·반품 비용",
		"배송·설치·보관·파손·재배송·반품비·무료배송 기준",
		"인테리어 관심과 판매가 함께 오르면 노출·할인 후보. 배송·설치 비용 정책이 없으면 비용 미반영 경고"
	],
	[
		"현대그린푸드",
		"농산물·수산물·축산물·가공·케어푸드",
		"product → sku → lot",
		"Q_available = 판매 가능한 로트의 현재 재고",
		"소비기한·온도·검사·이력추적·폐기량",
		"콜드체인·피킹·포장·보냉재·폐기·반품비",
		"메뉴·검색·판매가 함께 오르면 추가 입고 후보. 소비기한·검사 조건이 없으면 차단"
	]
];
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "웰니스·그린푸드는 로트, 리바트는 옵션이 반영된 SKU를 기준으로 재고·판매이력을 연결합니다." })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "02" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "언제까지 처리해야 할까?" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "식품은 소비기한, 가구는 납기·보관일, 웰니스는 최소 잔여기한을 사용합니다." })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "03" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "전략을 적용하면 어떤 비용이 생길까?" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "배송·설치·콜드체인·포장·반품·파손·폐기처럼 전략 손익에 실제로 변하는 값만 넣습니다." })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "04" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "전략을 제안하면 안 되는 경우는?" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "법적 제한·표시·검사·회수·소유권이 확인되지 않으면 이익 계산 전에 차단합니다." })
							] })
						]
					})
				]
		...
		/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("section", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "blueprint-guide-rule blueprint-guide-rule-green",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "외부 판매 시스템과의 경계" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "이 서비스는 주문·결제·배송·상품 등록을 실행하지 않습니다. 검증된 전략과 시뮬레이션 결과를 담당자가 확인하고, 필요하면 Teams로 외부 판매 시스템 담당자에게 전달합니다." })]
					})
				]
			})
		}),
