...
function getDraftSecret() {
	return "bbc3e0f7-515d-465c-bb60-cf8345f5d445";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "837d7e11-dc67-471b-baf2-a5be79d5ea12";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "837d7e11-dc67-471b-baf2-a5be79d5ea12") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "837d7e11-dc67-471b-baf2-a5be79d5ea12",
		rootBoundaryId
	});
}
/**
