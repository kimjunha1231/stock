...
function getDraftSecret() {
	return "8a85eb8f-517f-4f5c-8bed-bca82c8dec76";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "2a37885c-deb8-4672-8777-67e3f937b4b9";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "2a37885c-deb8-4672-8777-67e3f937b4b9") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "2a37885c-deb8-4672-8777-67e3f937b4b9",
		rootBoundaryId
	});
}
/**
...
var formulaRows = [
	...
	[
		"수요예측",
		"기본수요 + 트렌드 효과 + 가격 효과 + 프로모션 효과 + 계절·요일 효과",
		"기준모델보다 좋아지는지 시간순으로 검증"
	],
	[
		"실행 가능 여부",
		"소유권 확인 ∧ 판매 가능 ∧ 법적 제한 없음 ∧ 데이터 정상",
		"하나라도 모르면 추천·승인하지 않음"
	],
	[
		"비용 계산",
		"배송비 + 설치비 + 보관비 + 예상 파손비 + 예상 반품비 + 프로모션비",
		"SKU 비용이 없으면 계열사 기본 정책을 사용"
	],
	[
		"전략 이익",
		"할인 후 매출 − 비용 + 회피한 보관·폐기비용 − 잠식 − 위험손실",
		"기준선과 비교해 목적별 전략을 순위화"
	]
];
var strategyRows = [
	[
		"최대 마진",
		"기준선보다 추가 이익이 가장 큰 전략",
		"판매가·할인·배송·설치·보관·반품·폐기 비용",
		"최소 마진 미만 제외"
	],
	[
		"빠른 소진",
		"정해진 기간 안에 재고를 가장 빨리 줄이는 전략",
		"예상 판매량·처리기한·보관비·폐기비",
		"기한 안에 처리 불가하면 제외"
	],
	[
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "검색량 하나로 결론을 내리지 않고, 예측·위험·직접 비용·회피 비용을 같은 기준선과 비교합니다." })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SimpleTable, {
						caption: "계산 영역별 구조",
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "목표별 순위" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h3", { children: [
							"담당자가 목표를 고르면",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "순위 기준이 바뀝니다." })
						] })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SimpleTable, {
						caption: "전략 목표별 판단 기준",
						headers: [
							"목표",
							"쉬운 뜻",
							"중요하게 보는 값",
