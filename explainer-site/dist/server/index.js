...
function getDraftSecret() {
	return "a8c9362a-f886-430c-b833-f0b77472b1ae";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "e1c002ff-0e61-4a90-a4d8-ddf4b3f4ce19";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "e1c002ff-0e61-4a90-a4d8-ddf4b3f4ce19") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "e1c002ff-0e61-4a90-a4d8-ddf4b3f4ce19",
		rootBoundaryId
	});
}
/**
