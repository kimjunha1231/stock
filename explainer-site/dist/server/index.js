globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/content-a3QfrLIv.js","assets/reveal-YOJmgnTk.js","assets/image-CFgqE4Ha.js","assets/layout-segment-context-DztnB9lZ.js","assets/link-C9zE3rwN.js","assets/router-DPOdLdAo.js","assets/page-DavoQiTO.js","assets/page-B9YGep0F.js","assets/page-DK-vw55Q.js","assets/glossary-browser-DN1Ofyoq.js","assets/site-shell-DG25w3Th.js","assets/term-hint-XrwzxNq7.js"];
...
function getDraftSecret() {
	return "7aa46c49-bfe1-4fd0-99ad-46ab3972de2d";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "50391fac-d5c4-4612-8051-f2cfe1e295e6";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "50391fac-d5c4-4612-8051-f2cfe1e295e6") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "50391fac-d5c4-4612-8051-f2cfe1e295e6",
		rootBoundaryId
	});
}
/**
...
var productRows = [
	...
	[
		...
		"크기·중량·색상·옵션·창고·배송권역·설치 슬롯",
		"공간·배송·설치·파손·AS",
		"설치·배송 가능량을 넘지 않는 판매·공급"
	],
	[
		"현대그린푸드",
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Reveal, { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h1", { children: [
						"계열사와 상품이 달라도",
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "같은 기준으로 연결하는 설계" })
					] }) }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Reveal, { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "AI 모델, Oracle 데이터 구조, 통합 재고 표, 계열사별 전략 조건을 한 문서에 묶었습니다. 공통 엔진을 재사용하되 상품 특성은 프로필로 분리하는 것이 핵심입니다." }) }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "actions",
						style: { marginTop: 26 },
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(link_default, {
...
var page_exports$8 = /* @__PURE__ */ __exportAll({ default: () => AiGuidePage });
var aiFunctions = [
	{
		id: "AI-01",
		title: "트렌드 신호 수집·해석",
		...
		formula: "트렌드 점수 = 0.35×검색량 변화 + 0.25×SNS 변화 + 0.30×판매량 변화 + 0.10×조회수 변화",
	...
	},
	{
		...
		inputs: "판매이력·품절·반품·가격·할인·시즌·요일·트렌드 점수",
		output: "예상 일일 판매량, 예측 구간, 예상 소진일, 신뢰 상태",
		formula: "예상수요 = 기본수요 × (1 + 트렌드 효과) × 계절 효과 × 가격 효과 × 채널 효과",
	...
	},
	{
		...
		formula: "위험 점수 = 100 × Σ(신호 중요도 × 상품별 위험 정도)",
	...
	},
	{
		...
		use: "AI 설명 도우미는 계산된 숫자를 만들지 않고, 계산 결과를 쉬운 문장으로 설명하고 확인할 항목을 알려줍니다."
	},
	{
		id: "AI-05",
		title: "전략 시뮬레이션·설명",
		purpose: "수량·할인율·기간·비용을 바꿔 보면서 기준선, 추천안, 담당자 수정안을 같은 방식으로 비교합니다.",
		inputs: "시뮬레이션 조건·정책 버전·기준 시점 자료·수요예측 결과",
...
var affiliateRows = [
	[
		"현대웰니스",
		"건강기능식품·영양제",
		"성분·기능·대상, 로트·소비기한, 보관조건, 표시·주의사항",
		"소비기한 임박, 표시 누락, 회수·폐기 비용",
		"안전·표시·소비기한이 확인되지 않으면 추천하지 않음"
	],
	[
		"현대리바트",
		"가구·리빙·인테리어",
		"제품 크기·옵션, 창고 공간, 배송·설치 슬롯, 파손·AS 이력",
		"공간 점유, 배송·설치, 회수·재배송, 파손·AS",
		"설치·배송 가능량과 계약 조건을 확인한 뒤 판매량을 늘림"
	],
	[
		"현대그린푸드",
		"식품·식자재·케어푸드",
		"로트·소비기한, 온도등급, 검사 상태, 냉장·냉동 배송 가능량",
		"콜드체인, 보관·폐기, 배송·포장, 검사·리콜",
		"검사·보관조건·소비기한이 맞지 않으면 판매·추천을 차단"
	]
];
var trainingSteps = [
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Reveal, { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h1", { children: [
						"AI가 무엇을 보고,",
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "어떻게 추천하는지" }),
						" 한눈에 봅니다."
					] }) }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Reveal, { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "이 페이지는 개발자가 기능을 구현할 때 필요한 입력·계산·결과·예외 처리를 한 흐름으로 정리한 길라잡이입니다. AI는 상품을 마음대로 바꾸지 않고, 근거 있는 후보를 만들어 담당자의 판단을 돕습니다." }) }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "actions",
						style: { marginTop: 26 },
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(link_default, {
							className: "button primary",
							href: "/ai-blueprint",
							children: "AI 모델·데이터 설계 보기 →"
						}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(link_default, {
							className: "button secondary",
							href: "/formulas",
							children: "수식과 한글 설명 보기"
						})]
					})
				]
			})
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h2", { children: [
							"신호를 읽고,",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "수요와 재고를 함께 봅니다." })
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "트렌드가 발견되면 바로 입고나 할인으로 확정하지 않습니다. 데이터 품질과 계열사별 제한을 확인한 뒤 수요예측, 위험점수, 전략 계산 순서로 진행합니다." })
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Stagger, {
					className: "stack",
					children: [
						[
							"01",
							"외부·내부 신호 수집",
							"검색량·SNS·판매량·재고·프로모션을 같은 날짜 기준으로 모읍니다."
						],
						[
							"02",
							"트렌드 판정",
							"급증·급락·일시적 노출을 구분하고 신호의 출처와 강도를 남깁니다."
						],
						[
							"03",
							"수요예측",
							"평소 수요에 트렌드·시즌·가격 효과를 반영해 예상 판매량과 범위를 만듭니다."
						],
						[
							"04",
							"위험·전략 계산",
							"하드 차단을 먼저 적용하고, 남은 후보를 증분이익과 목표별 점수로 비교합니다."
						],
						[
							"05",
							"설명·승인",
							"AI는 이유를 쉬운 문장으로 설명하고, 담당자가 조건을 확인해 승인합니다."
						],
						[
							"06",
							"결과 회수",
							"실제 판매·매출·잔여재고를 연결해 예측 오차와 다음 기준을 업데이트합니다."
						]
					].map(([num, title, body]) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "stack-card",
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: title }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: body })] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: num === "05" ? "담당자" : "AI·자료" })
						]
					}, num))
				})]
			})
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h2", { children: [
							"개발할 때는",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "이 표대로 연결합니다." })
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "각 기능은 “필요한 자료 → 계산 → 화면에 보여줄 결과 → 실패 시 처리” 순서로 구현합니다." })
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					className: "capability-detail-table-wrap",
					children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("table", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("caption", {
								className: "sr-only",
								children: "AI 기능별 입력, 결과, 수식, 작동 예시"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("tr", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("th", {
									scope: "col",
							...
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("tbody", { children: aiFunctions.map((item) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("tr", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("td", { children: item.id }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("td", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: item.title }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
									style: {
										margin: "8px 0 0",
										fontWeight: 400
									},
								...
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("td", { children: item.inputs }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("td", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("code", { children: item.formula }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
									style: {
										margin: "8px 0 0",
										color: "#17734f"
									},
								...
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("td", { children: item.use })
							] }, item.id)) })
						]
					})
				})]
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h2", { children: [
							"공통 AI 위에",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "계열사별 정보를 얹습니다." })
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "수식의 뼈대는 공통으로 사용하지만, 어떤 신호를 중요하게 볼지와 차단 조건은 상품 특성에 맞게 다르게 설정합니다." })
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					className: "functional-spec-table-wrap",
					children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("table", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("tr", { children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("th", {
									scope: "col",
									children: "AI에 넣을 핵심 자료"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("th", {
									scope: "col",
									children: "주요 비용·위험 신호"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("th", {
									scope: "col",
									children: "먼저 확인할 조건"
							...
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("tbody", { children: affiliateRows.map((row) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("tr", { children: row.map((cell, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("td", { children: index === 0 ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: cell }) : cell }, `${row[0]}-${index}`)) }, row[0])) })
						]
					})
				})]
			})
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h2", { children: [
								"수요예측 모델은",
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "이 순서로 학습합니다." })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "처음부터 복잡한 모델을 붙이지 않고, 기준모델과 트렌드 반영 모델을 같은 기간에 비교해 실제 개선 여부를 확인합니다." })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Stagger, {
						className: "stack",
						children: trainingSteps.map(([title, body]) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", {
							className: "stack-card",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
									className: "stack-icon",
								...
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: title }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: body })] }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "GUIDE" })
							]
						}, title))
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "callout",
						style: { marginTop: 22 },
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "자동화의 경계" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "트렌드 신호는 입고 확대·할인·채널 전환을 “검토할 이유”로 제공합니다. 법적 제한, 재고 소유권, 공급·설치·콜드체인 가능량, 데이터 품질이 확인되지 않으면 전략 후보에서 제외하고 담당자 확인으로 보냅니다." })]
					})
				]
			})
		}),
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "담당자는 목적을 먼저 고릅니다." }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "같은 상품이라도 “얼마를 남길지”, “언제까지 줄일지”, “얼마나 팔지”에 따라 추천 결과가 달라집니다." })
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
					className: "strategy-goal-table-wrap",
					children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("table", {
