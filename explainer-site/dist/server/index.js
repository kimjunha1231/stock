...
function getDraftSecret() {
	return "501c874e-3ad1-433a-84a0-24e8167574f9";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "bd99dc02-e8d5-47f0-b998-3b3f89d3e17f";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "bd99dc02-e8d5-47f0-b998-3b3f89d3e17f") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "bd99dc02-e8d5-47f0-b998-3b3f89d3e17f",
		rootBoundaryId
	});
}
/**
