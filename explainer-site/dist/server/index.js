globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/content-CmIZYP-W.js","assets/reveal-YOJmgnTk.js","assets/image-CFgqE4Ha.js","assets/layout-segment-context-pl2X-gXu.js","assets/link-8nn-FTKM.js","assets/router-PNpgBI3B.js","assets/page-BxpsIuwm.js","assets/page-CZYeKb3o.js","assets/page-DK-vw55Q.js","assets/glossary-browser-DuqpyjKL.js","assets/site-shell-1BudzOkc.js","assets/term-hint-DHvgVo_j.js"];
...
function getDraftSecret() {
	return "bd3130f2-9b06-4590-98d6-f901d88e2126";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "465bd0a0-f6de-43f0-b063-3f65d377b793";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "465bd0a0-f6de-43f0-b063-3f65d377b793") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "465bd0a0-f6de-43f0-b063-3f65d377b793",
		rootBoundaryId
	});
}
/**
...
var modelRows = [
	[
		...
		"트렌드 신호 계산기",
		"통계 계산",
		"검색·SNS·조회·판매 변화율을 정규화해 상승·유지·하락 신호 생성",
		"상품 키워드, 수집시각, 상대 검색지수, 언급량, 순판매량",
		"학습보다 데이터 품질·출처·중복 제거를 먼저 확인"
	],
	[
		"모델 2",
		"트렌드 반영 수요예측",
		"학습 모델",
		"기본수요에 트렌드·가격·프로모션·요일·계절 효과를 추가해 일별 예측",
		"판매·품절·반품·가격·프로모션·트렌드 자료",
		"기준모델과 시간순 검증(rolling-origin)을 거친 뒤 운영 반영"
	],
	[
		"엔진 1",
		"위험·하드 차단 엔진",
		"규칙 엔진",
		"법규·소유권·기한·배송·설치·검사·데이터 품질을 먼저 검사하고 위험점수 계산",
		"정책 프로필, 재고, 로트, 비용, 가능량",
		"AI 학습 결과가 아니라 정해진 규칙으로 고정"
	],
	[
		"엔진 2",
		"전략·시뮬레이션 엔진",
		"수식 엔진",
		"허용된 후보의 예상 판매·매출·마진·잔여재고를 계산하고 목적별 순위화",
		"예측수요, 가격, 할인, 비용, 기준선, 정책 버전",
	...
	[
		...
		"AI 설명 도우미(LLM)",
		"생성형 AI",
		"계산 결과와 근거를 담당자가 이해할 문장과 확인 질문으로 변환",
		"계산 결과 데이터(JSON), 데이터 기간, 모델·정책 버전",
		"숫자·가격·수량을 새로 만들거나 바꾸지 않음"
	]
];
var productRows = [
	[
		"현대웰니스",
		"비타민·마그네슘·오메가3·콜라겐·세트",
		"성분·기능·대상·로트·소비기한·보관·표시",
		"소비기한·표시·회수·폐기",
		"잔여기한 기반 처리 속도·할인·묶음"
	],
	[
		"현대리바트",
		"거실·침실·주방 가구, 옵션·모듈 제품",
		"옵션·판매채널·배송권역·설치여부·비용정책",
		"배송비·설치비·보관비·예상 파손비·반품비·무료배송 기준",
		"비용을 반영해 할인·묶음·처리 전략 계산"
	],
	[
		"현대그린푸드",
		"농산물·수산물·축산물·가공식품·케어푸드",
		"로트·소비기한·온도·검사·이력추적·채널·콜드체인",
		"소비기한·검사·콜드체인·폐기",
		"로트별 소진·냉장/냉동 처리량·폐기 회피"
	]
];
var dbRows = [
	[
		"기준정보",
		"affiliate(계열사) · legal_entity(법인) · channel(판매채널) · category(카테고리) · brand(브랜드)",
		"어느 계열사의 어떤 상품인지 공통 ID로 연결"
	],
	[
		"상품",
		"product(상품) · product_option(상품 옵션) · sku(실제 판매 단위) · external_product_mapping(원천 코드 연결)",
		"상품 설명과 실제 판매 단위, 원천 시스템 코드를 보존"
	],
	[
		"재고",
		"inventory_snapshot(재고 시점) · inventory_lot(로트) · inventory_movement(입출고 이력)",
		"현재고·예약분·가용수량·로트·입출고 이력 저장"
	],
	[
		"판매",
		"sales_event(판매 기록) · promotion_event(프로모션 기록) · return_event(반품 기록)",
		"판매량·가격·할인·품절·반품을 날짜별로 저장"
	],
	[
		"AI 입력",
		"trend_signal(트렌드 신호) · feature_snapshot(계산용 자료 묶음) · forecast_run(예측 실행 기록)",
		"트렌드 원천과 예측값·예측구간·모델 버전 저장"
	],
	[
		"전략",
		"policy_profile(계열사 정책) · risk_assessment(위험 평가) · strategy_candidate(전략 후보) · simulation_run(시뮬레이션 기록)",
		"계열사 정책, 위험 이유, 후보와 시뮬레이션 결과 저장"
	],
	[
		"운영",
		"model_version(모델 버전) · data_quality_issue(데이터 오류) · approval_event(승인 기록) · audit_log(변경 이력)",
		"재현·승인·오류·변경 이력 추적"
	]
];
var profileRows = [
	[
		"현대웰니스",
		"wellness_product_profile",
		"성분·기능·대상·로트·소비기한·보관조건·표시·회수상태",
		"소비기한 임박·표시 누락·회수·폐기비용"
	],
	[
		"현대리바트",
		"livart_product_profile",
		"옵션·판매채널·배송권역·설치여부·비용정책",
		"배송·설치·보관·예상 파손·반품·AS 비용"
	],
	[
		"현대그린푸드",
		"greenfood_product_profile",
		"로트·소비기한·온도구분·검사·이력추적·채널·콜드체인",
		"보관·배송·검사·폐기·반품 비용"
	]
];
var costProfileRows = [
	[
		"sku_cost_profile",
		"상품별 비용",
		"sku_id·보관비 일단가·배송비·무료배송 기준금액·설치비·예상 파손비·예상 반품비·폐기비·할인 한도",
		"특정 상품만 다른 비용을 저장합니다."
	],
	[
		"affiliate_policy_profile",
		"계열사·카테고리 기본 비용",
		"affiliate_id·category_id·기본 배송비·기본 설치비·기본 보관비·기본 파손비·기본 반품비·무료배송 기준·적용기간·정책 버전",
		"SKU별 값이 없을 때 사용할 기본값입니다."
	],
	[
		"strategy_cost_snapshot",
		"계산 당시 비용 복사본",
		"snapshot_id·sku_id·배송비·설치비·보관비·예상 파손비·예상 반품비·폐기비·적용 정책 버전",
		"정책이 바뀌어도 과거 전략 결과를 다시 계산할 수 있게 합니다."
	]
];
var costCalculationRows = [
	[
		"배송비",
		"주문금액 ≥ 무료배송 기준금액이면 0원, 아니면 기본 배송비 + 지역 추가비",
		"할인 전략에서 무료배송 비용까지 이익에 반영"
	],
	[
		"설치비",
		"설치가 필요하면 설치비, 필요하지 않으면 0원",
		"현대리바트의 할인·묶음 전략에 반영"
	],
	[
		"보관비",
		"보관비 일단가 × 보관일수",
		"빠른 처리로 줄일 수 있는 비용은 회피비용으로 반영"
	],
	[
		"예상 파손·반품비",
		"예상 파손비 + 예상 반품비",
		"과거 비율을 쓰더라도 최종 계산에는 금액으로 변환"
	],
	[
		"최종 전략 이익",
		"할인 후 매출 − 배송비 − 설치비 − 보관비 − 파손·반품비 − 프로모션비 + 회피 폐기비용",
		"기준선과 비교해 목적별 전략 순위를 계산"
	]
];
var guideFormulaRows = [
	[
		"트렌드 신호",
		"검색관심도 변화 + SNS 언급량 변화 + 판매량 변화 + 조회·찜·장바구니 변화",
		"검색량만 급증해도 판매·재고 데이터가 부족하면 자동 입고로 확정하지 않음"
	],
	[
		"수요예측",
		"기본수요 + 트렌드 효과 + 가격 효과 + 프로모션 효과 + 계절·요일 효과 + 계열사·카테고리 효과",
		"처음에는 기준모델과 비교하고, 예측 범위와 데이터 부족 상태를 함께 표시"
	],
	[
		"위험 판단",
		"위험점수 0~100 + 법규·소유권·기한·배송·설치·검사 하드 차단",
		"점수가 낮아도 판매 불가 조건이면 추천 후보에서 제외"
	],
	[
		"전략 목적함수",
		"할인 후 매출 − 수수료 − 배송·설치비 − 프로모션비 − 반품비 + 회피 보관·폐기비용 − 잠식 − 위험손실",
		"기준선과 비교해 최대 마진·빠른 소진·최대 매출·위험 최소화 순위를 따로 계산"
	]
];
var operationSteps = [
	[
		"01",
		"원천 데이터 수집",
		"ERP·POS·WMS·판매채널에서 상품·재고·판매 자료를 가져옵니다."
	],
	[
		"02",
		"상품·SKU 통합",
		"계열사 원천 코드를 공통 상품·SKU ID와 연결합니다."
	],
	[
		"03",
		"품질·트렌드 확인",
		"품절·반품·오류를 정리하고 검색·SNS·판매 변화를 계산합니다."
	],
	[
		"04",
		"수요예측",
		"기본수요와 트렌드·가격·프로모션·계절 효과로 앞으로의 판매량을 예측합니다."
	],
	[
		"05",
		"위험·전략 계산",
		"하드 차단 후 전략 후보별 매출·비용·마진·잔여재고를 계산합니다."
	],
	[
		"06",
		"설명·승인·성과 회수",
		"AI가 결과를 쉽게 설명하고 담당자가 승인한 뒤 실제 결과를 다시 저장합니다."
	]
];
var aiFunctionRows = [
	[
		"AI-01",
		"트렌드 신호 수집·해석",
		"검색·SNS·판매·조회 변화가 갑자기 늘거나 줄었는지 감지",
		"검색어 추이·SNS 언급량·판매량·조회수·프로모션 노출량",
		"상승·하락 신호·변화율·출처·수집시각",
		"“검색과 판매가 2주 연속 늘었습니다. 입고 확대를 검토하세요.”"
	],
	[
		"AI-02",
		"트렌드 반영 수요예측",
		"평소 판매 흐름에 트렌드·계절·요일·가격·프로모션 효과를 반영",
		"판매이력·품절·반품·가격·할인·시즌·요일·트렌드 점수",
		"예상 일판매량·예측 범위·예상 소진일·신뢰 상태",
		"판매 이력이 부족하면 “예측 부족”으로 표시하고 자동 입고하지 않음"
	],
	[
		"AI-03",
		"위험재고 탐지",
		"판매속도·남은 기한·비용·데이터 품질로 위험 정도를 계산",
		"현재고·예상수요·보관일·소비기한·보관비·폐기비·품질상태",
		"위험점수 0~100·정상/주의/위험·판단 이유",
		"법규·소유권·기한·설치·검사 문제는 점수보다 먼저 추천 차단"
	],
	[
		"AI-04",
		"판매전략 후보 추천",
		"목표에 맞춰 할인·쿠폰·채널·번들·처리 시점을 조합",
		"예상수요·허용 할인·채널 비용·재고·처리기한·정책",
		"최대 3개 전략·예상 판매·매출·이익·잔여재고·추천 이유",
		"숫자는 수식 엔진이 계산하고 AI는 설명만 작성"
	],
	[
		"AI-05",
		"전략 시뮬레이션·설명",
		"수량·할인율·기간·비용을 바꾸며 기준선·추천안·수정안을 비교",
		"시뮬레이션 조건·정책 버전·기준 시점 자료·수요예측",
		"예상 판매·매출·마진·소진기간·잔여재고·회피비용",
		"조건을 바꿀 때마다 같은 수식으로 즉시 다시 계산"
	]
];
var forecastingSteps = [
...
var methodologyRows = [
	[
		"계열사 공식몰·사업 자료",
		"실제 상품군과 운영 방식이 맞는지 확인",
		"건강식품·가구·식품, 배송·설치·냉장/냉동·검사 같은 운영 조건",
		"계열사 확장 프로필·하드 차단·비용 항목으로 변환",
		"상품·재고 필드와 계열사별 전략 기준"
	],
	[
		"법·정책·공공 안내",
		"판매 전에 반드시 지켜야 하는 조건인지 확인",
		"소비기한·보관방법·표시·주의사항·검사·회수",
		"수익 계산보다 먼저 통과시키는 규칙으로 적용",
		"판매 가능 여부·추천 차단 기준"
	],
	[
		"검색 트렌드 자료·API 문서",
		"검색량의 의미와 수집 단위를 확인",
		"상대 검색 관심도·비교 기간·수집 시각·지역·일/주/월 추이",
		"판매·SNS·조회 신호와 합쳐 트렌드 신호로 저장",
		"트렌드 상승·하락과 수요예측 입력"
	],
	[
		"SNS·검색 수요예측 연구",
		"외부 신호가 실제 판매예측에 도움 되는지 확인",
		"SNS 언급량·검색지수·외생변수를 예측 피처로 쓰는 방법",
		"가중치를 그대로 복사하지 않고 내부 데이터로 개선 여부 검증",
		"트렌드 반영 수요예측 모델"
	],
	[
		"시계열 예측 방법론",
		"미래 데이터를 섞지 않고 예측을 검증하는지 확인",
		"기준모델·시간순 검증·예측 범위·계층별 합계 보정",
		"SKU→카테고리→계열사 합계가 맞는지 검증",
		"학습·검증 체크리스트와 모델 버전"
	],
	[
		"재고·가격·폐기비용 연구",
		"가격과 재고를 함께 바꿀 때 어떤 비용을 봐야 하는지 확인",
		"할인·재고·보관·폐기·반품·매출 잠식·처분 비용",
		"증분이익 목적함수와 전략 후보 순위에 반영",
		"최대 마진·빠른 소진·최대 매출·위험 최소화"
	],
	[
		"우리 프로젝트 요구사항",
		"실제 서비스에서 보여주고 실행할 범위를 확정",
		"3개 계열사 통합·원가 비노출·담당자 승인·비용 프로필·시뮬레이션",
		"공통 DB·정책 프로필·설명용 AI·사람 승인 구조로 조합",
		"사이트 기능명세·DB 설계·화면 컬럼"
	]
];
var methodologyRules = [
...
var strategyRows = [
	[
		"최대 마진",
		"기준선보다 추가 이익(M_inc)이 가장 큰 후보",
		"판매가·할인·수수료·배송·반품·회피비용",
		"최소 마진 미만이면 제외"
	],
	[
		"빠른 소진",
		"처리기한 안의 소진기간·잔여재고",
		"예측 판매량·현재고·처리기한·입고 리드타임",
		"기한 안에 처리 불가하면 제외"
	],
	[
		"최대 매출",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("aside", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
				...
				children: sourceItems.map((source) => source ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SourceNote, { source }, source.id) : null)
			})
		]
	});
}
function AiBlueprintPage() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: [
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Reveal, { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h1", { children: [
						"AI가 무엇을 보고,",
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "어떻게 추천하는지 한 번에 이해합니다." })
					] }) }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Reveal, { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "AI 기능, 계열사별 상품 데이터, Oracle 저장 구조, 통합 재고 화면, 수식, 학습·검증 순서를 하나로 연결했습니다. 처음 보는 팀원도 이 페이지를 읽고 개발 흐름을 설명할 수 있도록 구성했습니다." }) }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "actions",
						style: { marginTop: 26 },
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(link_default, {
		...
		/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("section", {
			className: "section blueprint-team-guide-section",
			children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				className: "container",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
								className: "eyebrow",
								children: "팀원용 상세 설계 가이드"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h2", { children: [
								"처음 읽는 팀원도",
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "이 페이지 하나로 이해합니다." })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "이 프로젝트는 계열사마다 AI를 따로 만드는 것이 아니라, 공통 계산 흐름에 계열사·상품별 정책 프로필을 끼워 넣는 구조입니다." })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "blueprint-decision-grid",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "학습 모델 1개" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "판매·품절·가격·프로모션·트렌드를 함께 보는 공통 수요예측 모델입니다." })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "02" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "통계 계산 1개" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "검색·SNS·조회·판매량 변화로 트렌드 상승·유지·하락을 계산합니다." })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "03" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "설명용 AI 1개" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "수식 엔진이 계산한 결과만 받아 담당자에게 쉬운 말로 설명합니다." })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "04" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "규칙·수식 엔진" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "위험 차단과 손익 계산은 같은 입력에 같은 결과가 나오도록 고정합니다." })
							] })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "blueprint-guide-rule",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "가장 중요한 분리 원칙" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [
							"AI 설명 도우미가 가격·수량을 직접 정하지 않습니다. ",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "수요예측 → 위험·하드 차단 → 전략 수식 계산 → AI 설명 → 담당자 승인" }),
							" 순서로 작동합니다."
						] })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "AI 기능별 상세" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h3", { children: [
								"필요한 자료부터",
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "화면에 보일 결과까지" })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "아래 표는 “무슨 AI인가”보다 실제 개발자가 연결해야 할 입력·결과·예외를 기준으로 정리했습니다." })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
						className: "blueprint-guide-table-wrap blueprint-ai-function-table-wrap",
						children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("table", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("caption", {
									className: "sr-only",
									children: "AI 기능별 입력·결과·사용 방식"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("tr", { children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("tbody", { children: aiFunctionRows.map((row) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("tr", { children: row.map((cell, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("td", { children: index === 0 ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("code", { children: cell }) : index === 1 ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: cell }) : cell }, `${row[0]}-${index}`)) }, row[0])) })
							]
						})
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "blueprint-guide-section-heading",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "계열사별 상품 프로필" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h3", { children: [
								"공통 상품 테이블에",
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "각 계열사 필드를 덧붙입니다." })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "실제 상품군이 다르기 때문에 소비기한·설치·콜드체인 같은 값은 계열사 확장 프로필에 저장합니다." })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
								className: "blueprint-guide-table-wrap",
								children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("table", {
									className: "blueprint-guide-table",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("caption", {
											className: "sr-only",
											children: "계열사별 확장 프로필과 위험 요소"
										}),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("tr", { children: [
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("th", {
												scope: "col",
											...
											/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("th", {
												scope: "col",
												children: "전략에서 먼저 보는 위험"
											})
										] }) }),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("tbody", { children: profileRows.map((row) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("tr", { children: row.map((cell, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("td", { children: index === 0 ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: cell }) : index === 1 ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("code", { children: cell }) : cell }, `${row[0]}-${index}`)) }, row[0])) })
									]
								})
							}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
								className: "blueprint-guide-rule blueprint-guide-rule-green",
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "MVP에서 가구 크기 필드는 저장하지 않습니다." }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "가로·세로·높이·부피를 계산하기보다, 전략에 직접 필요한 배송비·설치비·보관비·예상 파손비·반품비·무료배송 기준금액을 비용 프로필에 저장합니다. 나중에 실제 배송 연동에서 크기가 필요해질 때만 별도 필드로 확장합니다." })]
							})]
							...
							note: "공식 계열사 상품·사업 자료를 기준으로 필요한 필드를 나눈 이유입니다."
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "blueprint-guide-section-heading",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "비용 프로필 저장 방식" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h3", { children: [
								"원인을 추측하기보다",
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "계산에 쓸 비용을 저장합니다." })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "상품별 비용이 다르면 SKU 값으로 저장하고, 공통 비용은 계열사·카테고리 기본 정책으로 저장합니다." })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
						className: "blueprint-guide-table-wrap",
						children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("table", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("tbody", { children: costProfileRows.map((row) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("tr", { children: row.map((cell, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("td", { children: index === 0 ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("code", { children: cell }) : index === 1 ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: cell }) : cell }, `${row[0]}-${index}`)) }, row[0])) })
							]
						})
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "blueprint-guide-section-heading",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "비용이 계산되는 방식" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h3", { children: [
							"DB 값이 전략 점수로",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "어떻게 연결되는지" })
						] })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
						className: "blueprint-guide-table-wrap",
						children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("table", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("tbody", { children: costCalculationRows.map((row) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("tr", { children: row.map((cell, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("td", { children: index === 0 ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: cell }) : cell }, `${row[0]}-${index}`)) }, row[0])) })
							]
						})
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
							className: "blueprint-guide-section-heading",
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "공통 ID 기준" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h3", { children: [
								"DB는 이 키로",
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "끝까지 연결합니다." })
							] })]
						}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
							className: "blueprint-key-list",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("code", { children: "product_id" }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "공통 상품 단위" }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "계열사가 달라도 같은 상품 개념으로 묶는 ID입니다." })
								] }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("code", { children: "sku_id" }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "실제 재고·판매 단위" }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "용량·색상·사이즈·로트가 다르면 별도 SKU로 관리합니다." })
								] }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("code", { children: "source_sku_id" }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "원천 시스템 코드" }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "각 계열사의 ERP·POS·WMS 원본을 추적하는 코드입니다." })
								] }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("code", { children: "policy_profile" }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "계열사·카테고리 정책" }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "가중치·임계값·허용 전략·비용 계산 조건을 버전으로 저장합니다." })
								] })
							]
						})] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
							className: "blueprint-guide-section-heading",
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "개발자가 보는 입력·결과" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h3", { children: [
								"계산을 바꿔도",
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "근거가 남아야 합니다." })
							] })]
						}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
							className: "blueprint-rule-card",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "입력" }), " 상품·SKU·재고·판매·가격·프로모션·트렌드·계열사 정책·비용"] }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "결과" }), " 예측수요·위험점수·차단사유·전략 후보·예상 매출·마진·잔여재고"] }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "필수 기록" }), " 기준시각·데이터 상태·model_version·formula_version·policy_version·snapshot_id"] }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "보류 조건" }), " 데이터가 부족하거나 법규·기한·설치·검사·콜드체인 확인이 안 되면 “확인 필요”로 표시"] })
							]
						})] })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "blueprint-guide-section-heading",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "수식을 읽는 순서" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h3", { children: [
								"검색량 하나가 아니라",
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "여러 신호를 합쳐 판단합니다." })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "아래 표는 수식의 기술 이름보다 “무엇을 보고, 어떤 결정을 돕는지”를 먼저 설명합니다." })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
						className: "blueprint-guide-table-wrap",
						children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("table", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("tbody", { children: guideFormulaRows.map((row) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("tr", { children: row.map((cell, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("td", { children: index === 0 ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: cell }) : cell }, `${row[0]}-${index}`)) }, row[0])) })
							]
						})
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "blueprint-guide-section-heading",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "개발·운영 흐름" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h3", { children: [
							"데이터가 들어와",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "성과로 돌아오는 순서" })
						] })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
						className: "blueprint-operation-flow",
						children: operationSteps.map(([num, title, body]) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: num }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: title }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: body })
						] }, num))
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "blueprint-guide-section-heading",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "수요예측 학습 체크리스트" }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h3", { children: [
								"모델은 복잡하게 만들기보다",
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "검증 가능한 순서로 키웁니다." })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "기준모델보다 실제 오차가 줄었는지 확인한 뒤 다음 단계로 넘어갑니다." })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
						className: "blueprint-guide-table-wrap",
						children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("table", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("caption", {
									className: "sr-only",
									children: "수요예측 모델 학습 체크리스트"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("tr", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("th", {
									scope: "col",
									children: "단계"
								}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("th", {
									scope: "col",
								...
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("tbody", { children: forecastingSteps.map((row) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("tr", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("td", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: row[0] }) }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("td", { children: row[1] })] }, row[0])) })
							]
						})
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "blueprint-guide-rule blueprint-guide-rule-green",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "MVP에서 자동화하지 않는 것" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "자동 입고·자동 가격변경·자동 판매 등록은 하지 않습니다. 추천과 시뮬레이션 결과를 담당자가 확인하고 승인한 뒤 실제 운영으로 넘깁니다." })]
					})
				]
			})
		}),
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h2", { children: [
							"AI를 5개로 나누되,",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "모델은 최소화합니다." })
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "트렌드와 수요를 예측하고, 위험·손익 계산은 재현 가능한 엔진으로 고정합니다. AI 설명 도우미는 마지막 설명 단계에만 둡니다." })
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "blueprint-source-layout",
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("table", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("tbody", { children: modelRows.map((row) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("tr", { children: row.map((cell, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("td", { children: index === 1 ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: cell }) : cell }, `${row[0]}-${index}`)) }, row[0])) })
								]
							})
						})
					}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SourceRail, {
						...
						note: "검색·SNS 신호와 예측 검증 방식을 정한 근거입니다."
					})]
				})]
			})
		}),
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h2", { children: [
							"실제 상품군을 보면",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "필요한 필드가 달라집니다." })
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "공식몰·사업 페이지에서 확인되는 대표 상품과 운영 조건을 기준으로 DB 확장 필드를 정합니다." })
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "blueprint-source-layout",
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("table", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("tbody", { children: productRows.map((row) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("tr", { children: row.map((cell, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("td", { children: index === 0 ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: cell }) : cell }, `${row[0]}-${index}`)) }, row[0])) })
								]
							})
						})
					}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SourceRail, {
						...
						note: "공식 계열사 자료와 식품 표시 규정을 참고한 상품 필드입니다."
					})]
				})]
			})
		}),
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h2", { children: [
							"DB는 공통 테이블과",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "계열사 확장 프로필" }),
							"로 나눕니다."
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "상품을 한 표에 억지로 맞추지 않고, 공통 ID로 연결한 뒤 계열사에만 필요한 속성은 별도 프로필로 저장합니다." })
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "blueprint-source-layout",
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("table", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("tbody", { children: dbRows.map((row) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("tr", { children: [
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("td", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: row[0] }) }),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("td", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("code", { children: row[1] }) }),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("td", { children: row[2] })
									] }, row[0])) })
								]
							})
						}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
							className: "capability-callout",
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "중요한 키" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("code", { children: "product_id" }),
								"는 공통 상품, ",
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("code", { children: "sku_id" }),
								"는 실제 판매·재고 단위, ",
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("code", { children: "source_sku_id" }),
								"는 계열사 원천 코드입니다. 같은 이름의 상품이라도 SKU·옵션·로트가 다르면 반드시 별도 행으로 관리합니다."
							] })]
						})]
					}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SourceRail, {
						ids: ["project-types", "project-policy"],
						note: "공통 ID와 권한·정책을 분리하는 프로젝트 설계 근거입니다."
					})]
				})]
			})
		}),
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h2", { children: [
							"통합 재고는",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "이 항목으로 보여줍니다." })
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "담당자는 원가를 보지 않고도 무엇을 먼저 확인해야 하는지 알 수 있어야 합니다." })
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "blueprint-source-layout",
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
						className: "blueprint-source-main",
						children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
							className: "strategy-goal-table-wrap",
							children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("table", {
								className: "strategy-goal-table",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("caption", {
										className: "sr-only",
										children: "통합 재고 화면 컬럼"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("tr", { children: [
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("th", {
											scope: "col",
									...
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("tbody", { children: [
										[
											"계열사·카테고리",
											"어느 조직·상품군인지",
											"웰니스/영양제 · 리바트/거실가구 · 그린푸드/농산물",
											"필터·권한 범위"
										],
										[
											"상품·SKU·옵션",
										...
										[
											"위험점수·차단 상태",
											"0~100 점수와 실행 가능 여부",
											"표시 누락·검사 보류·설치 슬롯 부족",
											"우선순위·보류"
										],
										[
											"추천 다음 행동·기준시각",
											"검토용 행동과 데이터 신선도",
											"추가 입고 검토·할인 검토·유지·처리 우선",
											"담당자 승인·감사"
										]
									].map((row) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("tr", { children: row.map((cell, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("td", { children: index === 0 ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: cell }) : cell }, `${row[0]}-${index}`)) }, row[0])) })
								]
							})
						})
					}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SourceRail, {
						ids: ["project-types", "project-simulation"],
						note: "통합 재고에 표시할 공통 상태와 계산 결과의 기준입니다."
					})]
				})]
			})
		}),
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h2", { children: [
							"상품별 전략은",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "프로필을 바꿔 적용합니다." })
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "공통 목적함수는 유지하고, 각 계열사의 하드 차단·비용·시간축·가중치를 정책 프로필에서 읽습니다." })
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "blueprint-source-layout",
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("table", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("tbody", { children: strategyRows.map((row) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("tr", { children: row.map((cell, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("td", { children: index === 0 ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: cell }) : cell }, `${row[0]}-${index}`)) }, row[0])) })
								]
							})
						}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("code", { children: `feasible = ownership_ok ∧ legal_ok ∧ freshness_ok
           ∧ capacity_ok ∧ data_quality_ok` }),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "하나라도 확인되지 않으면 이익이 큰 후보도 추천하지 않습니다." })
									]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", {
									className: "formula-contract-card",
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("code", { children: `recommended_inbound = clip(
  target_stock - available - open_inbound,
  0, 공급·보관·처리 가능량)` }),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "트렌드 상승은 추가 입고 검토 신호이며 자동 확정이 아닙니다." })
									]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", {
									className: "formula-contract-card",
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("code", { children: `M_inc = feasible × (M_strategy - M_baseline)` }),
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "할인 후 매출, 변동비, 회피비용, 잠식·위험·AI 원가를 기준선과 비교합니다." })
									]
								})
							]
						})]
						...
						note: "가격·재고·폐기비용·잠식효과를 함께 계산하는 연구 근거입니다."
					})]
				})]
			})
		}),
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h2", { children: [
							"모델은 이 순서로",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "검증하고 운영합니다." })
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "상품군마다 데이터 양과 리스크가 다르므로, 복잡한 모델보다 기준모델 대비 개선 여부를 먼저 봅니다." })
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					className: "blueprint-source-layout",
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "blueprint-source-main",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Stagger, {
							className: "stack",
							children: [
								[
									"01",
									"품절·반품 보정",
									"품절일을 판매 부진으로 학습하지 않고, 취소·반품과 정상 판매를 분리합니다."
								],
								[
									"02",
									"기준모델 만들기",
									"계절 기준모델·가중 이동평균·지수평활(ETS) 중 성능이 좋은 기준모델을 둡니다."
								],
								[
									"03",
									"트렌드 자료 추가",
									"검색·SNS·조회·판매 신호를 추가하고 상품군별 가중치와 지연 효과를 비교합니다."
								],
								[
									"04",
									"시간 순서 검증",
									"미래 데이터를 섞지 않는 시간순 검증(rolling-origin)으로 예측 오차와 예측 범위를 측정합니다."
								],
								[
									"05",
									"계층 보정",
									"SKU 예측 합계가 카테고리·계열사·전체 집계와 맞는지 확인합니다."
								],
								[
									"06",
									"운영·재학습",
									"모델 버전·계산 자료·예측 오차를 저장하고 실제 결과가 쌓인 뒤 재학습합니다."
								]
							].map(([num, title, body]) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: title }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: body })] }),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "모델" })
								]
							}, num))
						}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
							className: "capability-callout",
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "보류 조건" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "트렌드와 판매 데이터가 상품에 정확히 매핑되지 않거나, 소비기한·검사·설치·콜드체인 정보가 없으면 해당 추천을 “예측 부족/확인 필요”로 표시합니다. 자동 입고·자동 가격변경은 검증 이후 단계입니다." })]
						})]
					}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SourceRail, {
						ids: [
							"forecasting-tscv",
						...
						note: "기준모델, 시간순 검증, 계층 보정을 정한 예측 방법론입니다."
					})]
				})]
			})
		}),
		/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("section", {
			className: "section blueprint-methodology-section",
			children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				className: "container",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
								className: "eyebrow",
								children: "근거를 설계로 바꾸는 과정"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h2", { children: [
								"무엇을 참고했고,",
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "어떻게 우리 서비스로 만들었나" })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "출처의 내용을 그대로 복사한 것이 아닙니다. 공식 자료에서 사실을 확인하고, 연구에서 계산 방법을 확인한 뒤, 우리 프로젝트의 범위와 내부 데이터로 구현 가능한 구조로 합쳤습니다." })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "blueprint-methodology-intro",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "자료를 합치는 기준" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "공식 자료" }),
							"는 “무엇을 관리해야 하는가”를 정하고, ",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "법·정책 자료" }),
							"는 “무엇을 먼저 차단해야 하는가”를 정합니다. ",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "연구·방법론" }),
							"은 “어떻게 계산하고 검증할 것인가”를 정하며, ",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "프로젝트 요구사항과 내부 데이터" }),
							"는 실제 화면·DB·비용값을 확정합니다."
						] })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
						className: "blueprint-guide-table-wrap",
						children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("table", {
							className: "blueprint-guide-table blueprint-methodology-table",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("caption", {
									className: "sr-only",
									children: "자료 종류별 참고 기준과 서비스 적용 방법"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("tr", { children: [
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("th", {
										scope: "col",
								...
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("tbody", { children: methodologyRows.map((row) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("tr", { children: row.map((cell, index) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("td", { children: index === 0 ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: cell }) : cell }, `${row[0]}-${index}`)) }, row[0])) })
							]
						})
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
								className: "blueprint-guide-section-heading",
								style: { marginTop: 0 },
								children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "자료를 읽는 방법" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h3", { children: [
									"확정된 사실과",
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
									/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "우리의 설계안을 구분합니다." })
								] })]
							}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
								className: "blueprint-guide-table-wrap",
								children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("table", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("tbody", { children: methodologyRules.map((row) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("tr", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("td", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: row[0] }) }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("td", { children: row[1] })] }, row[0])) })
									]
								})
							})]
						}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SourceRail, {
							...
							note: "이 페이지의 입력·계산·정책·검증 기준을 만든 참고 자료입니다."
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						className: "blueprint-methodology-result",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "결론" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [
							"현재 사이트의 DB·수식·화면은 외부 자료를 근거로 만든 ",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "설계 기준" }),
							"입니다. 실제 운영에 넣기 전에는 각 계열사의 원천 데이터와 비용 정책을 받아 필드명·단위·금액·가중치·임계값을 확정해야 합니다."
						] })]
					})
				]
			})
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", {
							className: "eyebrow",
							children: "이 설계에 참고한 출처"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h2", { children: [
							"근거 자료를",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "계산 옆에 남깁니다." })
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "공식 상품·사업 자료와 수요예측·재고 최적화 연구를 함께 참고했습니다." })
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
...
var page_exports$7 = /* @__PURE__ */ __exportAll({ default: () => page_default$2 });
...
var metadata$1 = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'metadata' is called on server");
}, "372050548a1b", "metadata");
var page_default$1 = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "372050548a1b", "default");
//#endregion
...
var scopeCards = [
	...
	["사람과 AI", "AI는 계산·비교·설명을 담당합니다. 가격·할인·수량·판매 조건 변경은 권한 있는 담당자가 승인합니다."]
];
var included = [
	"3개 계열사 상품·재고 공통 모델",
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", {
						className: "lead",
						children: [
							"위험재고·임박 capacity 규모, 처리기한 내 예상 처리율, 기준선 대비 ",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(link_default, {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "기한 안에 위험재고와 임박 capacity가 얼마나 줄었는가" })
							]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
							className: "metric-card",
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "예측과 실행 결과의 차이는 얼마인가" })
							]
						})
					]
				})]
...
var contexts = [
	...
	},
	{
		...
		tag: "가구·리빙",
		color: "violet",
		title: "상품 수량보다 설치와 공간이 중요합니다.",
		body: "부피·보관일·배송·설치·파손·AS capacity를 함께 보지 않으면 할인으로 수요를 늘려도 실행할 수 없습니다.",
		signal: "공간 점유 · 설치 슬롯 · 회수비"
	},
	{
		name: "현대그린푸드",
		tag: "식품·콜드체인",
		...
		body: "로트·소비기한·온도등급·검사 상태와 냉장·냉동 배송 capacity를 확인한 뒤 처리 대안을 비교합니다.",
		signal: "소비기한 · 온도 · 폐기·배송 capacity"
	}
];
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", {
						className: "lead",
						children: [
							"각 계열사 담당자는 자사의 비용·권한·capacity로 판단하고, 통합 운영은 위험 규모·처리율·",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(link_default, {
								href: "/glossary#incremental-profit",
								className: "inline-link",
								children: "증분이익"
					...
					className: "callout",
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", { children: "우리가 만들지 않는 것" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "통합 장바구니, 소비자 결제, 승인 없는 가격·수량 변경, 통합 운영의 일괄 승인. 이 서비스는 쇼핑몰이 아니라 의사결정 지원 도구입니다." })]
				})]
			})
		})
	] });
...
var roles = [
	{
		title: "계열사 책임 담당자",
		label: "OWNER",
		body: "자사 상품·재고·배송·설치 가능량과 비용 조건을 가장 잘 알고, 일반 전략을 승인하고 실행 결과에 책임집니다.",
		bullets: [
			"위험 항목 확인",
			"전략 비교·시뮬레이션",
			"승인·실행 요청",
	...
	},
	{
		title: "협력 부서",
		label: "COLLABORATE",
		body: "물류·마케팅·재무·정산·법무 담당자는 실행 가능성과 비용 부담을 확인해야 하는 케이스에만 참여합니다.",
		bullets: [
			"배송·설치·콜드체인 가능량 확인",
			"프로모션 조건 검토",
			"비용·정산 확정",
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("strong", {
							...
							children: "/formulas의 목적함수와 수요식은 공개 학술 연구를 바탕으로 한 공통 구조이고, 계열사별 상품·서비스 입력값과 법적 차단은 각 공식 자료·공공 규정으로 따로 검증합니다. 공개 자료로 확정할 수 없는 원가·수수료·capacity는 화면에서 “내부 계약 필요”로 구분합니다."
						})]
					})
				]
			})
