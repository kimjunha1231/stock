globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/content-B_xMv8g2.js","assets/reveal-YOJmgnTk.js","assets/image-CFgqE4Ha.js","assets/layout-segment-context-BB4z0Cqw.js","assets/link-UwIxy5Jt.js","assets/router-ZMHj4R5N.js","assets/page-CP56XhqS.js","assets/page-DCgakURd.js","assets/glossary-browser-Bw42vqFj.js","assets/site-shell-DyK5xMfL.js","assets/term-hint-n9o6L_SV.js"];
...
function getDraftSecret() {
	return "e37df6e3-cf5e-46b1-ada8-99dc4c2b187f";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "f94946a8-1f90-4bc1-9ef9-6886c45783b5";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "f94946a8-1f90-4bc1-9ef9-6886c45783b5") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "f94946a8-1f90-4bc1-9ef9-6886c45783b5",
		rootBoundaryId
	});
}
/**
...
var painPoints = [
	...
	[
		"▱",
		"방송",
		"방송 후 잔량은 반품·정산 지연까지 함께 봐야 합니다."
	],
	[
		"⌂",
		"부피",
		"가구는 설치·회수·파손 용량까지 전략의 조건이 됩니다."
	]
];
function HomePage() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: [
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Reveal, { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("span", {
							className: "hero-note",
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("i", {}), " 현대백화점 전 점포 AI 재고 의사결정 플랫폼"]
						}) }),
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Reveal, { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
							className: "lead",
							children: "상품을 가장 잘 아는 현대백화점 점포/부서가 직접 판단하고, AI는 비용·위험·기한을 비교해 실행 가능한 다음 수를 설명합니다."
						}) }),
		...
		/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("span", { children: "Built for different operating contexts" }),
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("b", { children: "현대홈쇼핑" }),
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", {
							className: "prd-card",
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: "문제" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "현대백화점 점포/부서마다 상품·비용·물류·처리기한이 다른데, 하나의 할인율이나 통합 쇼핑몰 방식으로 악성재고를 처리하면 실제 손실과 책임을 설명하기 어렵습니다." })]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", {
							className: "prd-card",
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: "1차 사용자" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "자사 재고의 상태와 비용을 알고 실제 실행 결과에 책임지는 현대백화점 점포/부서 재고 최적화 담당자입니다." })]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", {
							className: "prd-card",
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: "핵심 가치" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "위험재고를 찾고, 자사 기준선 대비 처리 대안을 비교하고, 담당자가 설명 가능한 근거로 승인하도록 돕습니다." })]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", {
							className: "prd-card",
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: "사람과 AI" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "AI는 계산·비교·설명을 담당합니다. 가격·할인·재고 처리는 권한 있는 사람이 승인합니다." })]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", {
							className: "prd-card",
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: "P1 포함 범위" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("ul", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: "직매입 재고 위험 탐지" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: "할인·타임세일·아울렛·기부·폐기 비교" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: "비용·증분이익 시뮬레이션" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: "승인·실행 결과 회수" })
							] })]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", {
							className: "prd-card",
							children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", { children: "P2 확장 범위" }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("ul", { children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: "점포 간 재고 이동" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: "점포/채널 공동 프로모션" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: "다른 점포·현대백화점 점포/부서 확장" }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: "승인된 우수 사례 표준화" })
							] })]
						})
					]
				})
...
var subsidiaries = [
	...
	},
	{
		...
		body: "냉장·냉동 전력, 유통기한, 식품안전과 당일 소진 시간이 재고의 우선순위를 결정합니다.",
		signal: "D-day · 온도 · 폐기·회수 조건"
	},
	{
		name: "현대홈쇼핑",
		tag: "방송·반품",
		color: "violet",
		title: "방송이 끝난 뒤에도 비용은 끝나지 않습니다.",
		body: "잔여재고를 볼 때 판매량만이 아니라 반품률, 정산 지연, 다음 방송 슬롯의 기회비용까지 확인합니다.",
		signal: "방송 잔량 · 반품률 · 정산 시점"
	},
	{
		name: "현대리바트",
		tag: "부피·설치",
		color: "orange",
		title: "상품 하나가 차지하는 운영 용량이 큽니다.",
		body: "가구는 단순 할인보다 보관 공간, 설치·회수 가능량, 파손과 예약 취소 조건이 더 큰 제약이 됩니다.",
		signal: "부피 · 설치 용량 · 파손·회수"
	}
];
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Reveal, { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("h1", { children: [
						"하나의 재고 기준으로는",
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("br", {}),
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("em", { children: "네 가지 현실" }),
						"을 설명할 수 없습니다."
					] }) }),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(Reveal, { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "악성재고라는 같은 이름 아래에 서로 다른 비용·기한·운영 책임이 있습니다. 먼저 이 차이를 인정해야 올바른 판단이 시작됩니다." }) })
				]
			})
		}),
		/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("section", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					className: "role-grid",
					children: subsidiaries.map((item) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", {
