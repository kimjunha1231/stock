		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "React 19 SPA, Java 21 Spring Boot Virtual Threads, MyBatis 단독 데이터 접근 계층, PostgreSQL JSONB, Python FastAPI 수리 최적화 엔진, Sentry 및 Prometheus/Loki/Jaeger 분산 관제까지 플랫폼 구축에 필요한 모든 기술의 선택 이유와 트레이드오프를 상세히 제공합니다." }) }),
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "lead",
								children: "대기업 엔터프라이즈 환경에서의 안정성, 초고속 60fps 시뮬레이션 반응성, 100% 무결한 수학적 수식 연산을 보장합니다."
							})
						]
					}),
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										...
										children: "React 19 + Zustand"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Next.js SSR 오버헤드 없이 Vite 기반 SPA로 오퍼레이션 타워 구축. Selector 기반 정밀 타겟 구독으로 슬라이더 조율 시 불필요한 전체 리렌더링을 차단하고 60fps 매끄러운 연동 보장." })
								]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
								className: "metric-card",
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "metric-value",
										children: "Virtual Threads + MyBatis 단독"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Java 21 가상 스레드로 동시 시뮬레이션 요청 처리. JPA를 배제하고 MyBatis 3.5+를 단독 채택하여 백화점/유통 ERP의 복잡한 SQL, CTE, 윈도우 함수를 개발자가 100% 직접 최적화 및 튜닝." })
								]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
								className: "metric-card",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Spring Boot와 분리된 독립 파이썬 연산 서비스. PuLP/SciPy로 최적 마진율을 100% 정확한 수학 공식으로 산출하고, LightGBM으로 가격 탄력성을 학습하며, Gemini/GPT-4o-mini로 현업용 사유 작성." })
								]
							})
						]
					}),
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
										...
										children: [
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
												style: { padding: "10px" },
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "vs Next.js (SSR)" }),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
													"B2B 내부 시스템으로 SEO가 필요 없으며 SSR 오버헤드 없이 빠른 빌드와 클라이언트 SPA 상태 유지가 뛰어남"
												]
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
												style: {
												...
												children: "SEO 미지원 (B2B 시스템이므로 무관)"
											})
										]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
										...
										children: [
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
												...
												children: "클라이언트 UI 상태는 별도 전역 스토어 필요"
											})
										]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
					...
					(activeTab === "all" || activeTab === "backend") && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
							...
							children: "⚙️ 2. 백엔드 (Backend) 기술 스택 역할 & 핵심 장점"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							style: { overflowX: "auto" },
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
								style: {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
										...
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
												...
												children: "Java 21 + Spring Boot 3.4"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
												style: { padding: "10px" },
												children: "엔터프라이즈 REST API 서비스, 멀티스레드 동시 요청 처리 및 트랜잭션 보장"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
												style: { padding: "10px" },
												children: [
													"• Virtual Threads로 I/O 처리량 극대화",
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
													"• 안정적인 대기업 엔터프라이즈 생태계",
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
													"• 강력한 멀티스레드 트랜잭션 처리"
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
												style: { padding: "10px" },
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "vs Node.js / Python" }),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
										...
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
												...
												children: "MyBatis 3.5+ (단독 채택, JPA 미사용)"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
												style: { padding: "10px" },
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "[단독 데이터 접근 계층]" }), " 재고 CRUD, 다중 조건 동적 필터링, 대용량 손실 집계 리포트, Window Function/CTE SQL 등 전체 DB 처리 전담"]
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
												style: { padding: "10px" },
												children: [
													"• SQL·실행계획을 개발자가 100% 직접 제어",
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
													"• PostgreSQL CTE·윈도우 함수 튜닝 용이",
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
													"• ERP/WMS 연동 쿼리와 레거시 스키마 대응"
												]
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
												style: { padding: "10px" },
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "vs JPA + QueryDSL" }),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
													"ORM 혼용 복잡도를 없애고 MyBatis XML/애노테이션의 ",
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("code", { children: "<if>" }),
													", ",
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("code", { children: "<choose>" }),
													", ",
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("code", { children: "<where>" }),
													"로 동적 SQL을 명시적으로 관리"
												]
											})
										]
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
										...
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
												...
												children: "Explicit Transition Service"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
												style: { padding: "10px" },
												children: "위험탐지➔검토➔승인➔실행➔완료 전이 통제, @Version 낙관적 잠금 및 감사 이력 기록"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
												style: { padding: "10px" },
												children: [
													"• 동일 재고 이중 승인 동시성 문제 완벽 방지",
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
												style: { padding: "10px" },
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "vs Spring State Machine" }),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
										...
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
												...
												children: "Spring Batch 5 + Spring @Scheduled"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
												style: { padding: "10px" },
												children: "매일 새벽 02시 전체 점포 직매입 재고 일일 손실액 및 위험도 자동 스냅샷 집계"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
												style: { padding: "10px" },
												children: [
													"• 실패 시 장애 지점부터 재시작(Restart) 보장",
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
												style: { padding: "10px" },
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "vs Quartz 복합 구성" }),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
										...
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
												...
												children: "Spring Security OAuth2 / OIDC"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
												style: { padding: "10px" },
												children: "사내 SSO/IdP 연동, 점포 담당자 vs 본사 예외 승인자 역할 기반 접근 권한(RBAC) 통제"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
												style: { padding: "10px" },
												children: [
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
												style: { padding: "10px" },
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "vs 커스텀 JWT 자체 발급" }),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
											...
											children: "PostgreSQL 16+"
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
											style: { padding: "10px" },
											children: "관계형 데이터 정규화 저장 + 시뮬레이션 파라미터 및 사후대처 트리 JSONB 저장"
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
											style: { padding: "10px" },
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "vs MySQL 8.0 / Oracle 19c" }),
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
												"100% 무료 오픈소스이면서 오라클급 CBO 최적화기 및 JSONB GIN 인덱싱 지원"
											]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
											style: {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
											style: { padding: "10px" },
											children: "실시간 위험재고 카운트 캐싱, 세션 관리, LLM 문장 생성 결과 Caching (0초 응답)"
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
											style: { padding: "10px" },
											children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
											...
											children: "메모리 관리 및 인메모리 휘발성 대비 필요"
										})
									]
								})] })]
							})
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
										...
										children: [
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
												style: { padding: "10px" },
												children: "보관비·폐기비·쿠폰 비용 반영 증분 기여현감이익 극대화 최적 할인율 계산"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
												style: { padding: "10px" },
												children: [
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
													"검증된 수리 방정식 최적화 엔진으로 오차 없는 정확한 마진 지점 산출"
												]
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
												style: {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
										...
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
												...
												children: "scikit-learn / LightGBM"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
												style: { padding: "10px" },
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
												...
												children: [
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
													"정형 숫자의 과거 데이터 학습에는 벡터 DB보다 ML 회귀 모델이 100% 정확함"
												]
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
												style: {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
										...
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
												...
												children: "Gemini 1.5 / Ollama / GPT-4o-mini"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
												style: { padding: "10px" },
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
												style: { padding: "10px" },
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "vs 로컬 LLM 파인튜닝" }),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
													"API 호출만으로 고품질 문장을 0원에 가깝게 활용 가능 (Gemini 하루 1,500회 무료)"
												]
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
												style: {
												...
												children: "외부 네트워크 연동 필요 (Ollama 대체 가능)"
											})
										]
									})
								] })]
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
										...
										children: [
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
												style: { padding: "10px" },
												children: "동시 접속자 500명 부하 상황에서의 P95 Latency 및 TPS 측정"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", {
												style: { padding: "10px" },
												children: [
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
													"자바스크립트 스크립트로 작성하기 쉬우며 리소스 소비가 극히 적음"
												]
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
												style: {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
										...
										children: "3. LLM 구조화 출력 & Redis 0초 캐싱"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										style: {
											fontSize: "0.88rem",
											color: "var(--color-text-muted)"
										},
										children: "LLM 호출 시 지정된 JSON 포맷만 반환하도록 강제하여 파싱 에러를 차단하며, 백화점 오퍼레이션 격식 템플릿을 적용합니다. 동일 재고 조건의 설명 문장은 Redis에 캐싱하여 0초 응답을 보장합니다."
									})]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									style: {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
										...
										children: "실제 실행된 프로모션 결과(실제 판매량, 증분이익)를 DB로 회수하여 AI 예상치와의 오차(MAPE)를 기록하고, 매월 파이썬 ML 모델이 스스로 재학습하여 정밀도를 지속적으로 향상시킵니다."
									})]
								})
							]
						})]
