...
import { a as sources } from "./content-dTZIMMT4.js";
...
var strategyGoalRows = [
	...
	{
		goal: "위험 최소화",
		easy: "폐기·보관·배송·파손 같은 손실을 가장 많이 줄이는 안",
		focus: "회피비용·위험손실·처리기한",
		inputs: "소비기한·설치일·보관기간·폐기비·배송비·실패확률",
  ...
  - 아무것도 바꾸지 않았을 때의 결과
		...
		terms: [
			...
			},
			{
				...
				detail: "보관비, 폐기비, 배송·파손비처럼 상품을 빨리 처리해서 줄어드는 비용입니다.",
...
그 외에는 0`,
		terms: [
			...
			},
			{
				symbol: "freshness_ok",
				meaning: "데이터가 최신인지",
				detail: "재고·가격·소비기한 정보가 오래되지 않았는지 확인합니다."
			},
			{
				symbol: "capacity_ok",
				meaning: "배송·처리할 여유가 있는지",
				detail: "배송, 설치, 냉장·냉동 공간이 부족하지 않은지 봅니다.",
	...
	demand: {
		...
		easy: "쉽게 말하면: 많이 팔릴 것처럼 보여도 실제 재고·배송·설치 가능 수량보다 크게 잡지 않습니다.",
		...
		terms: [
			{
				...
				detail: "할인이나 묶음판매를 적용했을 때 예상되는 판매 수량입니다."
			},
			{
				symbol: "Q_available",
				meaning: "실제로 팔 수 있는 최대 수량",
				detail: "판매 가능한 재고, 배송·설치 가능량처럼 현재 제공할 수 있는 한도입니다."
			},
			{
				symbol: "Q_base",
				meaning: "평소에 팔리던 수량",
			...
			},
			{
				symbol: "F_time",
				meaning: "남은 시간의 영향",
				detail: "소비기한, 납기·설치일까지 남은 시간이 판매량에 미치는 영향입니다.",
				glossaryId: "dday"
			},
			{
				symbol: "F_price",
  ...
  + 행사 준비에 드는 고정비`,
		terms: [
			...
			},
			{
				symbol: "commission",
				meaning: "판매 수수료",
				detail: "판매채널이나 제휴사에 지불하는 수수료입니다."
			},
			{
				symbol: "payment",
				meaning: "결제 처리비",
				detail: "결제와 주문을 처리할 때 드는 비용입니다."
			},
			{
				symbol: "fulfillment",
				meaning: "상품을 전달하는 비용",
	...
	avoided: {
		...
		easy: "쉽게 말하면: 지금 판매해서 보관비·폐기비·배송·파손 비용을 줄일 수 있는지, 실패하면 얼마를 잃을지 함께 봅니다.",
...
실패했을 때 예상되는 손해 = 실패 가능성 × 실패 손해`,
		terms: [
			...
			},
			{
				...
				meaning: "공간·처리 여유를 지켜 아낀 금액",
				detail: "창고·설치 슬롯·배송 공간을 비워 두지 않아 생긴 이익입니다."
			},
			{
				symbol: "RiskPenalty_s",
				meaning: "실패했을 때 예상되는 손해",
...
등급 = 정상 / 주의 / 위험`,
		terms: [
			...
			},
			{
				symbol: "w_k",
				meaning: "각 신호의 중요도",
				detail: "소비기한, 보관공간, 배송·파손 비용 중 무엇을 더 중요하게 볼지 정합니다."
			},
			{
				symbol: "z_ik",
...
var profiles = [
	...
	},
	{
		...
		note: "식자재 공급과 사전주문 상품은 수량·마감일·배송일을 함께 관리해야 합니다. 소비기한과 보관조건은 비용보다 먼저 검증하는 법정 입력입니다."
	}
];
...
var metadata = {
	...
	description: "현대웰니스·현대리바트·현대그린푸드의 상품 특성을 공통 목적함수로 계산하는 AI 재고 처리 수식"
};
function FormulasPage() {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
							"모든 상품은 “기준선보다 실제로 더 나아지는가”를 같은 방식으로 비교합니다. 각 카드 오른쪽 위의 ",
  ...
  ∧ data_quality_ok
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "하드 차단 조건이 0이면 이익이 큰 후보도 추천하지 않습니다. 식품의 소비기한·검사 상태, 리바트의 설치 슬롯, 웰니스 상품의 표시·보관정보가 여기에 들어갑니다." }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SourceLinks, { ids: ["project-policy", "food-label-standards"] })
						]
					})]
				})]
			})
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			className: "section-tight band formula-section strategy-goals-section",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "container",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "eyebrow",
								children: "01-B · Strategy goals"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", { children: [
								"목표에 따라",
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("em", { children: "전략 순위가 달라집니다." })
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "담당자가 먼저 목표를 고르면 시스템이 그 목표에 맞는 값을 중심으로 후보를 비교합니다. 법규·기한·capacity 같은 하드 차단은 어떤 목표보다 먼저 적용합니다." })
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: strategyGoalRows.map((row) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: row.goal }) }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: row.easy }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
										className: "strategy-goal-focus",
										children: row.focus
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: row.inputs }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: row.guardrail })
								] }, row.goal)) })
							]
						})
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "strategy-goal-note",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "전략 선택 순서" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "목표 선택 → 실행 가능 여부 확인 → 수요·매출·비용 계산 → 기준선과 비교 → 목표에 맞춰 순위화 → AI가 추천 이유 설명" })]
					})
				]
			})
		}),
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: "예상 판매량" }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormulaBlock, { children: `Q_s = min(Q_available,
  max(0, Q_base
    × F_time × F_price
    × F_channel × F_bundle
    × confidence))` }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("code", { children: "Q_available" }), "은 판매 가능한 실재고와 배송·설치 가능량 중 더 작은 값으로 제한합니다."] })
								]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
								className: "formula-panel formula-panel-with-help",
...
VariableCost_s = Q_s × (commission
  + payment + fulfillment + return_expected)
  + campaign_fixed_cost` }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "쿠폰·포인트·배송·설치·콜드체인·환불처럼 전략 때문에 변하는 현금만 분리합니다." })
								]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
								className: "formula-panel formula-panel-with-help",
...
RiskPenalty_s = probability × impact` }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "웰니스는 소비기한·표시·회수 비용, 리바트는 공간·설치·배송·파손 비용, 그린푸드는 소비기한·콜드체인·폐기 비용을 계열사 프로필에서 가져옵니다." })
								]
							})
						]
					}),
...
등급 = 정상 / 주의 / 위험` }),
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "웰니스·그린푸드" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "잔여기한 · 보관조건 · 예상 폐기량" })] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "현대리바트" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "부피·보관일 · 설치 슬롯 · 파손/AS" })] })]
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SourceLinks, { ids: [
						"project-policy",
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "eyebrow",
							children: "결과로 보여줄 값"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: "예상 판매량 · 예상 매출 · 증분 기여현금이익 · 마진율 · 소진일/잔여 capacity · 회피비용" })] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "승인된 전략은 revision과 데이터 cutoff를 함께 저장하고, 실제 판매 결과가 연결되면 예측 오차를 비교합니다." })]
					}),
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "3개 계열사 상품의 공통 목적함수, 위험점수, 계열사별 입력·비용·하드 차단, 출처 링크와 시뮬레이션 결과." })
								]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
								className: "evidence-card",
