...
var capabilityDetails = {
	...
	"F-05": {
		...
		considerations: [
			...
			"물리 재고와 예약 capacity를 같은 숫자로 오해하지 않음",
			"원가 권한에 따른 금액 마스킹"
		],
		done: [
			"홈에서 위험 규모를 확인",
	...
	"F-09": {
		...
		considerations: [
			"소비기한·출발일·설치 capacity를 넘는 조건 차단",
...
var affiliateProfiles = [
	...
	},
	{
		id: "travel",
		name: "더현대트래블",
		unit: "offer·좌석·객실·slot",
		color: "blue",
		focus: "출발일과 예약 capacity",
		fields: "departure_at · booking_cutoff_at · capacity · supplier_id · cancellation_rule_id",
		costs: "발권·상담 · 제휴수수료 · 환율 · 변경·재예약 · 공급사 위약금",
		stop: "예약 마감·공급사 규정·환불조건·capacity가 없으면 차단",
		signal: "출발 임박도 · fill rate · 취소비 · 규정 누락"
	},
	{
		id: "livart",
		name: "현대리바트",
...
var architectureLayers = [
	[
		"01",
		"원천 데이터",
		"ERP·POS·WMS·예약·정산에서 기준시각이 있는 snapshot과 이력을 받습니다."
	],
	[
		"02",
		"정책·하드 차단",
	...
	},
	{
		...
		rows: [
			[
				...
				"계열사 목록 조회",
				"담당자",
				"현대웰니스·더현대트래블·현대리바트·현대그린푸드 목록을 확인합니다.",
				"MVP"
			],
			[
				"BASE-002",
			...
			[
				...
				"카테고리 조회",
				"담당자",
				"가구·건강기능식품·여행·식품 등 공통 카테고리와 원천 카테고리를 구분해 봅니다.",
				"MVP"
			],
			[
				"BASE-006",
			...
			[
				...
				"상품 옵션 조회",
				"담당자",
				"색상·크기·용량·출발일·인원 등 상품별 선택 조건을 확인합니다.",
				"MVP"
			],
			[
				"BASE-008",
			...
			[
				...
				"판매 제한 정보 조회",
				"담당자",
				"소비기한·출발일·설치·검사·법적 표시 등 판매 제한 사유를 확인합니다.",
				"MVP"
			],
			[
				"BASE-011",
	...
	},
	{
		...
		rows: [
			[
				...
				"계열사 원천 데이터 수집",
				"시스템",
				"각 계열사의 상품·재고·판매·예약 데이터를 정해진 방식으로 가져옵니다.",
				"MVP"
			],
			[
				"DATA-002",
			...
			[
				...
				"재고 스냅샷 저장",
				"시스템",
				"특정 시각의 현재 재고와 여행 capacity를 기준 시각과 함께 저장합니다.",
				"MVP"
			],
			[
				"DATA-005",
				"판매이력 추가 저장",
				"시스템",
				"새로운 판매·예약 이력만 추가하고 기존 이력은 다시 저장하지 않습니다.",
				"MVP"
			],
			[
				"DATA-006",
				"재고 변동이력 저장",
				"시스템",
				"입고·판매·예약·조정으로 수량이 바뀐 흐름을 기록합니다.",
				"MVP"
			],
			[
				"DATA-007",
	...
	},
	{
		...
		rows: [
			[
				...
				"통합 재고 테이블 조회",
				"담당자",
				"네 계열사의 상품과 SKU를 한 표에서 비교하고 처리 대상을 찾습니다.",
				"MVP"
			],
			[
				"INV-002",
				"계열사별 재고 조회",
				"담당자",
				"현대웰니스·더현대트래블·현대리바트·현대그린푸드별로 필터링합니다.",
				"MVP"
			],
			[
				"INV-003",
			...
			[
				...
				"예약 capacity 구분",
				"담당자",
				"여행상품의 판매 가능 좌석·객실을 실물 재고와 다른 값으로 표시합니다.",
				"MVP"
			],
			[
				"INV-014",
	...
	},
	{
		...
		rows: [
			[
				...
				"전체 재고 수량 KPI",
				"담당자",
				"전체 계열사의 현재 재고 수량 또는 예약 가능량을 요약합니다.",
				"MVP"
			],
			[
				"DASH-002",
			...
			[
				...
				"기간별 판매량 차트",
				"담당자",
				"최근 7일·30일 등 기간별 판매·예약량 변화를 보여줍니다.",
				"MVP"
			],
			[
				"STAT-008",
	...
	},
	{
		...
		rows: [
			...
			[
				...
				"위험 판단 이유 표시",
				"담당자",
				"소비기한 임박·출발일 임박·설치 슬롯 부족 등 이유를 쉽게 보여줍니다.",
				"MVP"
			],
			[
				"RISK-004",
			...
			[
				...
				"계열사별 위험 요소 적용",
				"시스템",
				"웰니스·그린푸드는 소비기한, 여행은 출발일, 리바트는 설치·배송을 반영합니다.",
				"MVP"
			],
			[
				"RISK-006",
			...
			[
				...
				"최근 판매이력 조회",
				"시스템",
				"예측에 사용할 상품별 최근 판매·예약 이력을 가져옵니다.",
				"MVP"
			],
			[
				"DEMAND-002",
	...
	},
	{
		...
		rows: [
			...
			[
				...
				"번들 제한 검증",
				"시스템",
				"품절·법적 제한·기한·출발일·중복 상품 포함 여부를 확인합니다.",
				"P1"
			],
			[
				"BND-006",
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "네 계열사의 데이터와 서비스 책임을 한 문서에 연결했습니다. 공통 기능은 함께 보고, 계열사별 필수 입력·하드 차단·비용은 분리해서 확인합니다." }) })
