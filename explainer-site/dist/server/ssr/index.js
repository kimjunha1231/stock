...
var client_references_default = {
	...
	"372050548a1b": async () => {
		const m = await import("./assets/page-BIoJ1j2T.js");
		return {
			get "default"() {
				return m["default"];
			},
	...
	"9cc0f627b052": async () => {
		const m = await import("./assets/page-BejDvr_W.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	...
	"c2747888630f": async () => {
		const m = await import("./assets/link-BjpPdlMN.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"ca88aed2258a": async () => {
		const m = await import("./assets/page-DK8GfOQE.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"e0b926a333ff": async () => {
		const m = await import("./assets/site-shell-Cc5Q-R1S.js");
		return { get "SiteShell"() {
			return m["SiteShell"];
		} };
	},
	"f30fcd25c92f": async () => {
		const m = await import("./assets/term-hint-BCbubift.js");
		return { get "TermHint"() {
			return m["TermHint"];
		} };
	},
	"fa4438e99613": async () => {
		const m = await import("./assets/glossary-browser-B7vUOI2w.js");
