...
var client_references_default = {
	...
	"372050548a1b": async () => {
		const m = await import("./assets/page-Dg39nf8a.js");
		return {
			get "default"() {
				return m["default"];
			},
	...
	"9cc0f627b052": async () => {
		const m = await import("./assets/page-DTv1PrTv.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	...
	"ca88aed2258a": async () => {
		const m = await import("./assets/page-Cy7HCtfo.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"e0b926a333ff": async () => {
		const m = await import("./assets/site-shell-CL8UINsJ.js");
		return { get "SiteShell"() {
			return m["SiteShell"];
		} };
	},
	"f30fcd25c92f": async () => {
		const m = await import("./assets/term-hint-BKqX_QbT.js");
		return { get "TermHint"() {
			return m["TermHint"];
		} };
	},
	"fa4438e99613": async () => {
		const m = await import("./assets/glossary-browser-B9c5zRdf.js");
