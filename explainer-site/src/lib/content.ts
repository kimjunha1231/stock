export type GlossaryTerm = {
  id: string;
  term: string;
  category: '기본 개념' | '재무 기준' | '재고·물류' | '마케팅·고객' | 'AI·운영';
  short: string;
  definition: string;
  formula?: string;
  example: string;
...
export const sources: SourceItem[] = [
  ...
  { id: 'hds-esg', kind: '현대백화점', title: '현대백화점 지속가능경영보고서 2024', location: '보고 범위·GRI/SASB·K-IFRS', note: '전국 15개 백화점과 9개 아울렛 범위의 공개 보고서', url: 'https://kind.krx.co.kr/external/2025/06/30/000286/20250618000183/61979.htm' },
  { id: 'hds-service', kind: '현대백화점', title: '현대백화점 서비스 제도', location: '식품안전 보증제·식품 감식관·냉장 보관·선물 배송', note: '식품 전략에서 가격보다 먼저 확인할 운영 접점', url: 'https://www.ehyundai.com/newPortal/CS/CS000004_V.do' },
  { id: 'hds-return', kind: '현대백화점', title: '현대백화점 교환·환불 서비스', location: '구매 후 7일·상품군별 신선식품 예외', note: '반품률과 재판매 가능성을 상품군별로 나눠야 하는 근거', url: 'https://www.ehyundai.com/newPortal/CS/CS000003_V.do' },
  { id: 'hds-subscription', kind: '현대백화점', title: '현대식품관 식품 구독', location: '배송일 2일 전 변경·중간 취소·매장/앱 결제', note: '식품 예약·배송·취소 capacity를 전략 변수로 만드는 근거', url: 'https://www.ehyundai.com/newPortal/FS/FS000001_V.do' },
  { id: 'hds-vip', kind: '현대백화점', title: '현대백화점 2026 Club YP', location: '할인 제외 상품군·임대매장·온라인몰 적용 조건', note: 'VIP를 만능 할인 수단으로 가정하지 않는 근거', url: 'https://www.ehyundai.com/HD/VIP/2025/yp/serp.do' },
  { id: 'hds-circular', kind: '현대백화점', title: '현대백화점 자원순환', location: '폐비닐 화학적 재활용·Project100·365 리사이클', note: '폐기 비용과 ESG 처리 증빙을 분리하는 근거', url: 'https://www.ehyundai.com/newPortal/RC/ENV00003_V.do' },
  { id: 'hds-hai', kind: '현대백화점', title: '현대백화점 생성형 AI 멘토 Hai', location: '현대퓨처넷 협업·13개 직무·139명 전문가', note: '생성형 AI는 설명과 업무 보조에 연결된다는 공개 사례', url: 'https://www.ehyundai.com/newPortal/group/GN/GNN000020_V.do?seq=434' },
  { id: 'hds-heydi', kind: '현대백화점', title: '쇼핑 AI Heydi', location: '실시간 점포 정보·브랜드·팝업·프로모션 추천', note: '실시간 운영 정보와 대화형 안내를 분리해 연결하는 공개 사례', url: 'https://www.ehyundai.com/newPortal/group/GN/GNN000010_V.do?seq=691' },
...
export const glossary: GlossaryTerm[] = [
  ...
  },
  {
    ...
    related: ['baseline', 'contribution-cash', 'avoidable-cost'],
    sourceIds: ['project-policy'],
  },
  {
    ...
    related: ['incremental-profit', 'sunk-cost', 'avoidable-cost'],
  ...
  },
  {
    ...
    related: ['risk-stock'],
    sourceIds: ['project-policy', 'hds-service', 'mfds-useby'],
  },
  {
    ...
    example: 'D-3 대게는 전국 배송보다 당일 수령·근거리 예약을 먼저 비교합니다.', related: ['risk-stock', 'hard-stop'], sourceIds: ['project-types', 'hds-service', 'mfds-useby'],
  },
  {
    id: 'direct-purchase', term: '직매입', category: '재고·물류', short: '백화점이 상품을 매입하고 재고 위험을 직접 부담하는 방식',
    definition: '재고의 판매·보관·폐기 결과가 현대백화점 점포/부서의 손익에 직접 연결되는 구매 유형입니다. 프로젝트에서는 P0 우선순위입니다.',
    example: '직매입 식품은 할인·배송·폐기비를 현대백화점 점포/부서 손익 기준으로 계산합니다.', related: ['special-purchase', 'leased-store'], sourceIds: ['project-types', 'project-policy'],
  },
  {
    id: 'special-purchase', term: '특약매입', category: '재고·물류', short: '판매·정산·반품 조건을 계약으로 나눠 부담하는 방식',
    definition: '직매입과 달리 소유권·반품권·비용분담·정산 방식이 계약에 따라 달라질 수 있습니다. 직매입처럼 계산하면 이익이 왜곡됩니다.',
    example: '특약매입은 할인 전에 벤더 부담률과 반품 가능 여부를 확인합니다.', related: ['direct-purchase', 'leased-store'], sourceIds: ['project-types', 'project-policy'],
  },
  {
    id: 'leased-store', term: '임대매장', category: '재고·물류', short: '매장 운영자가 상품 소유와 가격 권한을 갖는 형태',
    definition: '백화점이 임대료·수수료를 받는 구조로, 재고 소유권과 할인 승인권이 매장에 있을 수 있습니다. AI는 권한 확인 전 가격 전략을 실행하지 않습니다.',
    example: '임대매장 상품은 벤더 공동행사나 별도 협의 후보로 둡니다.', related: ['direct-purchase', 'special-purchase', 'hard-stop'], sourceIds: ['project-types', 'hds-vip'],
  },
  {
    id: 'sales-velocity', term: '판매속도', category: '재고·물류', short: '하루 또는 기간당 얼마나 팔리는지 나타내는 값',
    definition: '현재고가 언제 소진될지 추정하는 기본 신호입니다. 판매속도만 보지 않고 노출·날씨·요일·행사·재고 품절 여부를 함께 확인합니다.',
    formula: '판매속도 = 기간 판매수량 ÷ 기간 일수', example: '최근 30일 판매속도와 행사 후 판매속도를 분리해 봅니다.', related: ['dday', 'scenario'], sourceIds: ['project-simulation', 'project-policy'],
  },
  {
    id: 'holding-cost', term: '보관비', category: '재고·물류', short: '재고를 하루 더 보유하면서 생기는 비용과 공간 대체가치',
    definition: '창고·냉장전력·피킹·공간 점유뿐 아니라 같은 공간을 다른 상품에 쓸 수 없게 되는 기회비용까지 포함할 수 있습니다.',
    example: '대형 리빙 상품은 판매가보다 공간 대체가치가 전략을 바꿀 수 있습니다.', related: ['avoidable-cost', 'disposal-cost'], sourceIds: ['project-policy', 'project-simulation'],
  },
  {
    id: 'disposal-cost', term: '폐기비', category: '재고·물류', short: '폐기물 처리·운송·증빙에 드는 실제 비용',
    definition: '회계상 손상차손과 실제 현금성 처리비를 분리해야 합니다. 기부·벤더 회수·자원순환 비용도 무료라고 가정하지 않습니다.',
    example: '폐기하지 않았다는 이유만으로 비용이 0원이 되지 않으며, 처리 증빙을 남깁니다.', related: ['avoidable-cost', 'hard-stop'], sourceIds: ['project-policy', 'hds-circular', 'allbaro'],
  },
  {
    ...
    formula: '반품률 = 반품 수량 ÷ 판매 수량', example: '의류와 신선식품의 반품 조건을 같은 값으로 두지 않습니다.', related: ['contribution-cash', 'delivery-capacity'], sourceIds: ['hds-return', 'project-simulation'],
  },
  {
    ...
    example: 'D-5 식품을 할인해도 당일 배송 capacity가 없으면 판매 전략이 아닙니다.', related: ['dday', 'return-rate'], sourceIds: ['hds-subscription', 'hds-service', 'project-simulation'],
  },
  {
  ...
  {
    id: 'fallback', term: 'Fallback', category: 'AI·운영', short: '첫 전략이 예상대로 작동하지 않을 때의 다음 처리 단계',
    definition: '판매율이 낮아질수록 앱 노출, 제한 쿠폰, 번들, 별도 채널, 회수·기부·폐기처럼 다음 행동을 미리 정해두는 운영 트리입니다.',
    example: '누적 판매 30% 미만이면 추가 할인보다 회수·기부·폐기 비용을 비교합니다.', related: ['scenario', 'disposal-cost'], sourceIds: ['project-simulation', 'project-policy'],
  },
  {
    id: 'ai-decision-cost', term: 'AI 결정원가', category: 'AI·운영', short: 'AI가 재고 전략을 찾고 설명하는 데 쓰는 비용',
    definition: '데이터 추출·피처·검색·모델·LLM·도구·오케스트레이션·사람 검토·평가·실패 reserve를 합친 비용입니다. 할인·배송비와 별도로 기록합니다.',
    formula: 'C_AI_case = DATA + FEATURE + SEARCH + MODEL + LLM + TOOL + ORCH + HUMAN + EVAL + SHARED', example: '슬라이더 100회는 LLM 100회가 아니라 수식 재계산 100회로 처리합니다.', related: ['contribution-cash', 'human-in-loop'], sourceIds: ['project-policy', 'project-simulation', 'openai-pricing'],
  },
  {
    id: 'human-in-loop', term: 'Human-in-the-loop', category: 'AI·운영', short: 'AI가 제안하고 권한 있는 사람이 승인하는 구조',
    definition: 'AI는 가격·재고를 확정하지 않습니다. 현대백화점 재고 담당자가 데이터·조건·하방 결과를 확인한 뒤 실행을 승인하고 결과를 회수합니다.',
    example: '식품 안전·소유권·브랜드 예외는 담당자 승인 없이는 실행하지 않습니다.', related: ['hard-stop', 'ai-decision-cost'], sourceIds: ['project-policy', 'hds-hai', 'hds-heydi'],
  },
];
...
export const screenshots = [
  { src: '/screens/dashboard.png', label: '대시보드', title: '위험의 크기를 한눈에 파악합니다', body: '전관 재고 총액, 직매입 리스크 비중, 회피 폐기비용과 층별 위험도를 한 화면에서 비교합니다.' },
  { src: '/screens/inventory-all.png', label: '통합 재고 관제', title: '우선 처리할 재고를 좁힙니다', body: '상품별 보관일수와 위험도 점수를 확인하고, 담당자가 검토할 후보를 선택합니다.' },
  { src: '/screens/strategy-history.png', label: '전략 기록', title: '선택한 전략의 이유를 남깁니다', body: '과거 전략과 실제 성과를 비교해 현대백화점 점포/부서에 맞는 판단 패턴을 축적합니다.' },
