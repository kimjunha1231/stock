...
export const glossary: GlossaryTerm[] = [
  ...
  },
  {
    ...
    example: '소유권과 쿠폰 부담 주체가 확인되지 않은 상품은 이익 계산을 확정하지 않고 검토 대기 상태로 둡니다.', related: ['hard-stop', 'contribution-cash'], sourceIds: ['project-types', 'project-policy'],
  },
  {
  ...
  },
  {
    ...
    example: '폐기하지 않았다는 이유만으로 비용이 0원이 되지 않으며, 처리 증빙을 남깁니다.', related: ['avoidable-cost', 'hard-stop'], sourceIds: ['project-policy', 'allbaro'],
  },
  {
  ...
  },
  {
    ...
    example: '식품 안전·소유권·브랜드 예외는 담당자 승인 없이는 실행하지 않습니다.', related: ['hard-stop', 'ai-decision-cost'], sourceIds: ['project-policy', 'pipc-genai'],
  },
];
...
export const navItems = [
  ...
  { href: '/crawling-data', label: '크롤링 & ERD' },
...
export const mvpMenu = [
  {
    id: '01', label: '홈 대시보드', kind: '처음 확인하는 요약 화면',
    purpose: '오늘 무엇부터 처리할지 빠르게 판단합니다.',
    features: ['전체 재고 수량·금액', '정상·주의·위험 비율', '계열사별 위험재고 규모', '우선 처리 TOP 5', '최근 데이터 갱신 시각'],
  },
  {
  ...
  },
  {
    ...
    features: ['전략 수정·버전 저장', 'Teams 검토 요청', '전송 상태 확인', '예상 대비 실제 판매·매출·마진', '목표 달성률·예측 오차'],
  },
  {
    id: '08', label: '기준정보·운영', kind: '관리·이력 화면',
    purpose: '공통 기준과 시스템 처리 이력을 확인합니다.',
    features: ['계열사·상품·카테고리·SKU 조회', '데이터 동기화 이력', '위험분석·수요예측 이력', 'AI 전략·Teams 전송 이력', '배치·오류 상태 확인'],
  },
];
