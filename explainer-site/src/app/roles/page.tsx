...
const roles = [
  { title: '계열사 책임 담당자', label: 'OWNER', body: '자사 상품·재고·예약 capacity와 비용 조건을 가장 잘 알고, 일반 전략을 승인하고 실행 결과에 책임집니다.', bullets: ['위험 항목 확인', '전략 비교·시뮬레이션', '승인·실행 요청', '결과 회신'] },
  ...
  { title: '협력 부서', label: 'COLLABORATE', body: '물류·마케팅·재무·정산·법무 담당자는 실행 가능성과 비용 부담을 확인해야 하는 케이스에만 참여합니다.', bullets: ['배송·설치·예약 capacity 확인', '프로모션 조건 검토', '비용·정산 확정', '결과 데이터 연결'] },
];
