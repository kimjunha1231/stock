...
const contexts = [
  ...
  { name: '더현대트래블', tag: '예약 capacity', color: 'mint', title: '출발일이 곧 처리기한입니다.', body: '항공·호텔·패키지는 물리 재고가 아니므로 잔여 좌석·객실·공급사 취소 규정을 기준으로 비교합니다.', signal: '출발일 · 예약률 · 취소·위약금' },
...
export default function ProblemPage() {
  return <>
    <section className="page-hero"><div className="container"><Reveal><span className="eyebrow">01 · The problem</span></Reveal><Reveal><h1>네 계열사의 상품은<br /><em>위험해지는 이유가 다릅니다.</em></h1></Reveal><Reveal><p>상품·예약 capacity·채널·처리기한·계약 조건에 따라 비용과 위험이 달라집니다. 통합 서비스는 같은 수식을 쓰되, 계열사별 입력과 차단 기준을 다르게 적용합니다.</p></Reveal></div></section>
