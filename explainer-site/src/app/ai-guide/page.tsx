  ...
  return <>
    <section className="page-hero capability-hero">
      <div className="container">
        <Reveal><span className="eyebrow">AI 기능 길라잡이</span></Reveal>
    ...
    <section className="section">
      <div className="container">
        <div className="section-heading"><span className="eyebrow">계열사별 입력 자료</span><h2>공통 AI 위에<br /><em>계열사별 정보를 얹습니다.</em></h2><p>수식의 뼈대는 공통으로 사용하지만, 어떤 신호를 중요하게 볼지와 차단 조건은 상품 특성에 맞게 다르게 설정합니다.</p></div>
    ...
    <section className="section band">
      <div className="container">
        <div className="section-heading"><span className="eyebrow">수요예측 학습 순서</span><h2>수요예측 모델은<br /><em>이 순서로 학습합니다.</em></h2><p>처음부터 복잡한 모델을 붙이지 않고, 기준모델과 트렌드 반영 모델을 같은 기간에 비교해 실제 개선 여부를 확인합니다.</p></div>
    ...
    <section className="section">
      <div className="container">
        <div className="section-heading"><span className="eyebrow">전략 목표</span><h2>담당자는 목적을 먼저 고릅니다.</h2><p>같은 상품이라도 “얼마를 남길지”, “언제까지 줄일지”, “얼마나 팔지”에 따라 추천 결과가 달라집니다.</p></div>
