                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.9rem' }}>
                  ...
                  <tbody>
                    ...
                    <tr style={{ borderBottom: '1px solid var(--color-border)' }}>
                      ...
                      <td style={{ padding: '10px' }}>
                        • SQL·실행계획을 개발자가 100% 직접 제어<br />
                        • PostgreSQL CTE·윈도우 함수 튜닝 용이<br />
                        • ERP/WMS 연동 쿼리와 레거시 스키마 대응
                      </td>
                      <td style={{ padding: '10px' }}>
                        <strong>vs JPA + QueryDSL</strong><br />
                        ORM 혼용 복잡도를 없애고 MyBatis XML/애노테이션의 <code>&lt;if&gt;</code>, <code>&lt;choose&gt;</code>, <code>&lt;where&gt;</code>로 동적 SQL을 명시적으로 관리
                      </td>
                    </tr>
                    <tr style={{ borderBottom: '1px solid var(--color-border)' }}>
