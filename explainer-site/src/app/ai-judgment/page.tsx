...
export default function AIJudgmentPage() {
  return <>
    <section className="page-hero"><div className="container"><Reveal><span className="eyebrow">03 · AI judgment</span></Reveal><Reveal><h1>AI에게 맡기는 것은<br /><em>결정</em>이 아니라 비교입니다.</h1></Reveal><Reveal><p>AI는 계열사·상품군·채널별 정책과 데이터를 바탕으로 대안을 계산하고 설명합니다. 가격·할인·수량·예약 capacity 처리는 권한 있는 담당자가 승인해야 실행됩니다.</p></Reveal></div></section>
    ...
    <section className="section-tight"><div className="container"><div className="callout"><strong>사람의 통제선</strong><p>각 계열사의 책임 담당자는 일반 전략을 승인하고 결과에 책임집니다. 통합 운영·관리자는 공통 지표, 예외 기준, 계열사 간 조정이 필요한 사안만 검토합니다.</p></div></div></section>
  </>;
}
