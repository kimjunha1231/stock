...
export default function ProductTourPage() {
  return <>
    ...
    <section className="section-tight band"><div className="container"><div className="callout"><strong>캡처를 보는 방법</strong><p>화면에 보이는 숫자는 실제 운영 화면의 데모 데이터입니다. 핵심은 AI가 자동으로 확정하는 것이 아니라, 근거와 후보를 제시하고 현대백화점 재고 담당자가 승인하는 구조입니다.</p></div></div></section>
  </>;
}
