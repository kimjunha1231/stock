...
t4_data = [
    ...
    ("김준하", "풀스택 총괄 / 백엔드-파이썬 수리 최적화 마진 연산 엔진, OpenAI GPT-4o-mini API 연동, DB 정규화 스키마 설계 및 전체 시스템 아키텍처 통합"),
...
print(f"Updated docx with new timeline saved to {output_path}")
